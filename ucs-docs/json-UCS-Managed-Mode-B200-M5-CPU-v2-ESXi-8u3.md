# UCS Managed Mode B200 M5 CPU v2 / ESXi 8u3

| | |
|---|---|
| **URL Title** | UCS Managed Mode B200 M5 CPU v2 / ESXi 8u3 |
| **URL** | https://pwc014-nextgen-prod-rcdn.cisco.com/public/v2/searchBy/server/searchResults?serverType_ID=0&serverModel_ID=199,247&processor_ID=173&osVendor_ID=5&osVersion_ID=1025&firmwareVersion_ID=-1&manageType=UCSM&searchBy=servers&loadDataFromJson=undefined |
| **Long URL** |  |
| **HTML Title** |  |
| **Source file** | `ucs-docs-raw/json/searchResults.json` |
| **File type** | JSON |
| **Fetched on** | 2026-03-04 11:01:08 |
