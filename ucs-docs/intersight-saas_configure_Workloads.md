# Intersight SaaS Configure Workloads guide

| | |
|---|---|
| **URL Title** | Intersight SaaS Configure Workloads guide |
| **URL** | https://intersight.com/help/saas/configure/Workloads |
| **Long URL** | https://cdn.intersight.com/components/an-hulk/1.0.11-20260414151805446/docs/cloud/data/articles/features/workloads/configure/en/index.html |
| **HTML Title** | Document |
| **Source file** | `ucs-docs-raw/html/intersight-saas_configure_Workloads.html` |
| **File type** | HTML |
| **Fetched on** | 2026-04-16 10:49:13 |

---

Workloads provide a mechanism for end users to define a collection of configurations that can be applied consistently and repeatedly across a group of servers, devices, or clusters managed collectively as a fleet. Workloads are the top-level component of fleet groups.
