...
Table 1. Release 6.0(1) Release |  Date |  Description  
---|---|---  
...
CSCwi16863 |  A watchdog reset causes the BMC to perform a hard reset on the Cisco UCS B200 M6 or X210c M6 servers and FI with infra version 4.2(3d).  The reset is logged with system event messages indicating the CIMC reboot due to the watchdog reset assertion. This issue is resolved. |  4.2(3d) |  6.0(1b)A   
...
Table 2. Cisco UCS Manager and C-Series Software releases for C-Series Servers Cisco UCS Manager Release  |  C-Series Standalone Releases Included |  C-Series Servers Supported by the C-Series Standalone Releases   
---|---|---  
...
---|---  
Table 3. Mixed Cisco UCS Releases Supported on Cisco UCS 6652, 6664, 6536, and 6400 series Fabric Interconnects |  Infrastructure Versions (A Bundles)  
---|---  
Host FW Versions (B or C Bundles)  |  4.2(1) |  4.2(2) |  4.2(3) |  4.3(2) |  4.3(3) |  4.3(4) |  4.3(5) |  4.3(6) |  6.0(1)  
6.0(1) |  —  |  —  |  —  |  —  |  —  |  —  |  —  |  —  |  6664, 6536, 6454, 64108  
4.3(6) |  —  |  —  |  —  |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6536, 6454, 64108  
4.3(5) |  —  |  —  |  —  |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6536, 6454, 64108  
4.3(4) |  —  |  —  |  —  |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6536, 6454, 64108  
...
4.2(3) |  6200, 6332, 6332-16UP, 6454, 64108 |  6200, 6332, 6332-16UP, 6454, 64108 |  6200, 6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6536, 6454, 64108  
...
Table 4. Mixed Cisco UCS Releases Supported on Cisco UCS X-Series Direct Host FW Versions (B Bundles)  |  Infrastructure Versions (A Bundles)   
---|---  
...
Table 5. Upgrade Paths to Release 6.0(1) Upgrade from Release |  Recommended Upgrade Path  
---|---  
...
Any other older release |  Upgrade:
  ...
  1. Upgrade to release 4.2(3) or later. |  **Note** |  Refer [Release Notes for Cisco UCS Manager, Release 4.2](https://www.cisco.com/c/en/us/td/docs/unified_computing/ucs/release/notes/cisco-ucs-manager-rn-4-2.html) to identify the recommended upgrade path to release 4.2(3).   
---|---  
...
Table 6. Cisco UCS NVMeoF Support Matrix for 3rd Party Storage Vendors Storage Vendor |  Feature |  Storage Array |  Cisco UCS FI |  Cisco UCS VIC |  Operating System  
---|---|---|---|---|---  
...
|  **Note** |  Cisco UCS VIC 1300 series is supported only with RHEL 8.6+. Refer <https://hwu.netapp.com/> for latest Storage Array support details.  A valid NetApp® account is required to access the compatibility information.  Not tested with NetApp E-Series or SolidFIre Storage Models.  
---|---  
...
NVMe-ROCEv2 |  Purity//FA onwards 6.8.7 |  6664 |  15000 14000 |  ESXi 8.0 U3+ ESXi 9.0+ RHEL 9.6+ RHEL 10+ SLES 15SP5+  
...
Dell Inc.® |  NVMe-FC |  PowerStore PowerMax |  6300 6400 6536 |  1400 14000 15000 |  ESXi 7.0U3+ RHEL 8.6+ SLES 15SP3+  
NVMe-FC |  PowerStore PowerMax |  UCSX-S9108-100G |  15000 |  ESXi 7.0U3+ ESXi 8.0U2+ RHEL 8.9+ RHEL 9.3+ SLES 15SP4+  
NVMe-FC |  PowerStore PowerMax |  6664 |  15000 14000 |  ESXi 8.0 U3+ ESXi 9.0+ RHEL 9.6+ RHEL 10+ SLES 15SP5+  
NVMe-TCP |  PowerStore PowerMax |  6300 6400 6536 |  1400 14000 15000 |  ESXi 7.0U3+ RHEL 8.6+ SLES 15SP3+  
NVMe-TCP |  PowerStore PowerMax |  UCSX-S9108-100G |  15000 |  ESXi 7.0U3+ ESXi 8.0U2+ RHEL 8.9+ RHEL 9.3+ SLES 15SP4+  
...
Table 7. Cisco UCS FI Appliance Port Support Matrix Protocol |  Vendor |  Partner Support |  Cisco Support  
---|---|---|---  
...
Table 8. Cisco UCS Fabric Interconnect and MDS Release Support Matrix Fabric Interconnect |  Older Supported Release of MDS |  Recommended release of MDS  
---|---|---  
Cisco UCS 6652 FI |  9.2 |  9.4  
...
Table 9. Compatibility and Support Matrix for Cisco Fabric Interconnects & Nexus Switches 6.0(1) Fabric Interconnect |  Older Supported Release of NX-OS |  Recommended release of NX-OS  
---|---|---  
Cisco UCS 6652 FI |  — |  10.5(x)  
...
Table 10. Cisco UCS Fabric Interconnect and Brocade Release Support Matrix Cisco UCS Fabric Interconnect |  Older Supported Release of Brocade |  Recommended Release of Brocade  
---|---|---  
Cisco UCS 6652 FI |  — |  9.2  
...
---|---|---|---|---|---  
22  | CLI | SSH | TCP  |  UCS 6652 FI UCS 6664 FI UCS 6400 Series FI UCS 6536 FI UCSX-S9108-100G | Cisco UCS Manager CLI access   
80  | XML | HTTP | TCP  |  UCS 6652 FI UCS 6664 FI UCS 6400 Series FI UCS 6536 FI UCSX-S9108-100G |  Cisco UCS Manager GUI and third party management stations.  Client download   
443  | XML | HTTP | TCP  |  UCS 6652 FI UCS 6664 FI UCS 6400 Series FI UCS 6536 FI UCSX-S9108-100G |  Cisco UCS Manager login page access  Cisco UCS Manager XML API access   
743 | KVM | HTTP | TCP |  UCS 6652 FI UCS 6664 FI UCS 6400 Series FI UCS 6536 FI UCSX-S9108-100G | CIMC Web Service / Direct KVM  
7546 | CFS | CFSD | TCP |  UCS 6652 FI UCS 6664 FI UCS 6400 Series FI UCS 6536 FI UCSX-S9108-100G | Cisco Fabric Service  
...
Table 11. Supported Hardware for UCS 6600 Series Fabric Interconnects Type |  Details  
---|---  
...
**Fabric Extenders** |  93180YC-FX3 (25G server ports) UCSX-I-9108-25G or UCSX-I-9108-100G (Supported with Cisco UCS X-Series Servers) N9K-C93180YC-FX3  UCS-IOM- 2408  
...
Table 12. Supported Hardware for UCS 6500 Series Fabric Interconnects Type |  Details  
---|---  
...
Table 13. Supported Hardware for UCS 6400 Series Fabric Interconnects Type |  Details  
---|---  
...
Table 14. Cisco UCS X-Series Direct Supported Chassis  Chassis |  Minimum Software Version |  Suggested Software Version  
---|---|---  
Cisco UCS X9508 Chassis | 4.3(4b) |  6.0(1f)  
Table 15. Supported Hardware for Cisco UCS X-Series Direct Fabric Interconnects  |  Minimum Software Version  |  Suggested Software Version   
---|---|---  
Cisco UCS 9108-100G  | 4.3(4b) |  6.0(1f)  
...
---|---  
Table 16. Cisco UCS 6600 Series Fabric Interconnect Gb Connector Modules  |  Transceiver Modules and Cables   
---|---  
...
Table 17. Cisco UCS 6500 Series Fabric Interconnects Gb Connector Modules  |  Transceiver Modules and Cables   
---|---  
...
Table 18. Cisco UCS 6400 Series Fabric Interconnects Gb Connector Modules  |  Transceiver Modules and Cables   
---|---  
...
Table 19. Cisco UCS X-Series Direct Supported Gb Connector Modules Gb Connector Modules  |  Cables   
---|---  
...
Table 20. Supported GPU/GPU PCIe Node GPU/GPU PCIe Node |  PID |  Supported Servers |  Minimum Software Version |  Suggested Software Version  
---|---|---|---|---  
NVIDIA A16 GPU on X440p: PCIE 250W 4X16GB, FHFL  |  UCSX-GPU-A16 |  Cisco UCS X210c M8 (with PCIe Node)  |  4.3(6a) |  6.0(1f)  
UCSC-CGPU-A16 |  Cisco UCSX215c M8 (with PCIe Node)  |  4.3(5a) |  6.0(1f)  
AMD MI210 GPU; 300W 64GB, 2 slot FHFL |  UCSX-GPU-MI210 |  Cisco UCS X215c M8 |  4.3(6a) |  6.0(1f)  
NVIDIA H100-NVL GPU 400W, 94GB, 2-slot FHFL  |  UCSX-GPU-H100-NVL |  Cisco UCS X210c M8 (with PCIe Node)  |  4.3(6a) |  6.0(1f)  
UCSC-GPU-H100-NVL |  Cisco UCS C240 M8 |  4.3(6a) |  6.0(1f)  
Cisco UCS X210c M7 Cisco UCS X215c M8 (with PCIe Node)  |  4.3(5a) |  6.0(1f)  
Cisco UCS C245 M8 |  4.3(5a) |  6.0(1f)  
Cisco UCS C240 M7 |  4.3(5a) |  6.0(1f)  
NVIDIA L4-Mezz GPU 70W, 24GB, 1-slot HHHL |  UCSX-GPU-L4-Mezz |  Cisco UCS X210c M7 Cisco UCS X215c M8 |  4.3(5a) |  6.0(1f)  
UCSX-440P-D GPU PCIe Node |  UCSX-440P-D |  Cisco UCS X210c M7, X210c M6, and X410c M7 |  4.3(4a) |  6.0(1f)  
Intel GPU Flex 140, Gen4x8, HHHL, 75W PCIe (Front Mezz) |  UCSX-GPU-FLX140MZ |  Cisco UCS X210c M7 |  4.3(2b) |  6.0(1f)  
Intel GPU Flex 140, Gen4x8, HHHL, 75W PCIe |  UCSX-GPU-FLEX140 |  Cisco UCS X410c M7 and X210c M7 (with PCIe Node) |  4.3(4a) |  6.0(1f)  
UCSC-GPU-FLEX140 |  Cisco UCS C220 M7 and C240 M7 |  4.3(4a) |  6.0(1f)  
Intel GPU Flex 170, Gen4x16, HHFL, 150W PCIe |  UCSX-GPU-FLEX170 |  Cisco UCS X410c M7 and X210c M7 (with PCIe Node) |  4.3(4a) |  6.0(1f)  
UCSC-GPU-FLEX170 |  Cisco UCS C240 M7 |  4.3(4a) |  6.0(1f)  
NVIDIA TESLA A16 PCIE 250W 4X16GB |  UCSX-GPU-A16-D |  Cisco UCS X210c M7 and X210c M6 (with PCIe Node) |  4.3(4a) |  6.0(1f)  
Cisco UCS X410c M7 (with PCIe Node) |  4.3(4a) |  6.0(1f)  
UCSC-GPU-A16 |  Cisco UCS C240 M8 |  4.3(6a) |  6.0(1f)  
Cisco UCS C240 M6 |  4.2(1d) |  6.0(1f)  
Cisco UCS C245 M6 |  4.2(1i) |  6.0(1f)  
NVIDIA L4 Tensor Core, 70W, 24GB |  UCSX-GPU-L4 |  Cisco UCS X210c M8 (with PCIe Node)  |  4.3(6a) |  6.0(1f)  
Cisco UCS X210c M7 (with PCIe Node) |  4.3(4a) |  6.0(1f)  
Cisco UCS X410c M7 (with PCIe Node) |  4.3(4a) |  6.0(1f)  
NVIDIA L40 300W, 48GB wPWR CBL |  UCSX-GPU-L40 |  Cisco UCS X210c M7 (with PCIe Node) |  4.3(4a) |  6.0(1f)  
Cisco UCS X410c M7 (with PCIe Node) |  4.3(4a) |  6.0(1f)  
UCSC-GPU-L40 |  Cisco UCS C240 M7 |  4.3(2b) |  6.0(1f)  
Cisco UCS X215c M8 (with PCIe Node)  |  4.3(5a) |  6.0(1f)  
NVIDIA L40S: 350W, 48GB, 2-slot FHFL GPU |  UCSX-GPU-L40S | Cisco UCS X210c M8 (with PCIe Node)  |  4.3(6a) |  6.0(1f)  
Cisco UCS X210c M7 (with PCIe Node) Cisco UCS X410c M7 (with PCIe Node) |  4.3(4a)  
UCSC-GPU-L40S | Cisco UCS C240 M8 |  4.3(6a) |  6.0(1f)  
Cisco UCS C240 M7 |  4.3(4a) |  6.0(1f)  
Cisco UCS X215c M8 (with PCIe Node)  |  4.3(5a) |  6.0(1f)  
NVIDIA T4 PCIE 75W 16GB |  UCSX-GPU-T4-16 |  Cisco UCS X210c M6 (with PCIe Node) |  4.3(4a) |  6.0(1f)  
UCSC-GPU-T4-16 |  Cisco UCS C220 M6 |  4.3(2b) |  6.0(1f)  
Cisco UCS C245 M6 |  4.2(1f) |  6.0(1f)  
Cisco UCS C225 M6 |  4.2(1l) |  6.0(1f)  
Cisco UCS C240 M5, C220 M5, and C480 M5 |  3.2(3a) |  6.0(1f)  
Cisco UCS S3260 M5 |  3.1(2b) |  6.0(1f)  
NVIDIA T4 GPU PCIE 75W 16GB, MEZZ form factor (Front Mezz) |  UCSX-GPU-T4-MEZZ |  Cisco UCS X210c M7 and X210c M6 |  4.3(2b) |  6.0(1f)  
NVIDIA Hopper L4 70W, 24GB, 1-slot HHHL |  UCSC-GPU-L4M6 |  Cisco UCS C220 M6, C240 M6 |  4.3(4a) |  6.0(1f)  
NVIDIA H100: 350W, 80GB, 2-slot FHFL GPU |  UCSX-GPU-H100-80 |  Cisco UCS X210c M7 and X410c M7 (with PCIe Node) |  4.3(4a) |  6.0(1f)  
UCSC-GPU-H100-80 |  Cisco UCS C240 M7 |  4.3(4a) |  6.0(1f)  
NVIDIA L4:70W, 24GB, 1-slot HHHL GPU |  UCSC-GPU-L4 |  Cisco UCS C240 M8 and C220 M8 |  4.3(6a) |  6.0(1f)  
Cisco UCS C245 M8 |  4.3(5a) |  6.0(1f)  
Cisco UCS C220 M7 and C240 M7 |  4.3(2b) |  6.0(1f)  
Cisco UCS X215c M8 (with PCIe Node)  |  4.3(5a) |  6.0(1f)  
NVIDIA P4 |  UCSC-GPU-P4 |  Cisco UCS C220 M5 |  3.2(3a) |  6.0(1f)  
NVIDIA M10 |  UCSC-GPU-M10 |  Cisco UCS C240 M5 and C480 M5 |  3.2(3a) |  6.0(1f)  
NVIDIA GRID P6 Front Mezzanine |  UCSB-GPU-P6-F |  Cisco UCS B200 M5 |  3.2(1d) |  6.0(1f)  
Cisco UCS B480 M5 |  3.2(2b) |  6.0(1f)  
NVIDIA GRID P6 Rear Mezzanine |  UCSB-GPU-P6-R |  Cisco UCS B200 M5 |  3.2(1d) |  6.0(1f)  
Cisco UCS B480 M5 |  3.2(2b) |  6.0(1f)  
TESLA A30, PASSIVE, 180W, 24GB |  UCSC-GPU-A30-D |  Cisco UCS C240 M7 |  4.3(2b) |  6.0(1f)  
UCSC-GPU-A30 |  Cisco UCS C240 M6 |  4.2(1d) |  6.0(1f)  
Cisco UCS C245 M6 |  4.2(1i) |  6.0(1f)  
TESLA A40 RTX, PASSIVE, 300W, 48GB |  UCSX-GPU-A40-D |  Cisco UCS X210c M7 and X210c M6 (with PCIe Node) |  4.3(4a) |  6.0(1f)  
Cisco UCS X410c M7 (with PCIe Node) |  4.3(4a) |  6.0(1f)  
UCSC-GPU-A40-D |  Cisco UCS C240 M7 |  4.3(2b) |  6.0(1f)  
UCSC-GPU-A40 |  Cisco UCS C240 M6 |  4.2(1d) |  6.0(1f)  
Cisco UCS C245 M6 |  4.2(1i) |  6.0(1f)  
Cisco UCS C480 M5 |  3.2(3a) |  6.0(1f)  
TESLA A100, PASSIVE, 300W, 80GB12 |  UCSX-GPU-A100-80-D |  Cisco UCS X210c M7 and X210c M6 (with PCIe Node) |  4.3(4a) |  6.0(1f)  
Cisco UCS X410c M7 (with PCIe Node ) |  4.3(4a) |  6.0(1f)  
UCSC-GPUA100-80-D |  Cisco UCS C240 M7 |  4.3(2b) |  6.0(1f)  
UCSC-GPU-A100-80 |  Cisco UCS C240 M6 |  4.2(1d) |  6.0(1f)  
Cisco UCS C245 M6 |  4.2(1i) |  6.0(1f)  
All Cisco UCS C-Series M5 |  4.2(2c) |  6.0(1f)  
TESLA A10, PASSIVE, 150W, 24GB |  UCSC-GPU-A10 |  Cisco UCS C240 M6 |  4.2(1d) |  6.0(1f)  
Cisco UCS C245 M6 |  4.2(1i) |  6.0(1f)  
NVIDIA H200-NVL GPU |  UCSC-GPU-H200-NVL |  Cisco UCS C240 M8 |  4.3(6c) |  6.0(1f)  
...
Table 21. Version Mapping UCS Release |  Catalog File Name |  Additional PIDs in this Release  
---|---|---  
...
The following table lists the mixed A, B, and C bundle versions that are supported on Cisco UCS 6664, 6536, and 6400 series Fabric Interconnects: 

Table 1. Mixed Cisco UCS Releases Supported on Cisco UCS 6664, 6536, and 6400 series Fabric Interconnects |  Infrastructure Versions (A Bundles)  
---|---  
Host FW Versions (B or C Bundles)  |  4.0(1) |  4.0(2) |  4.0(4) |  4.1(1) |  4.1(2) |  4.1(3) |  4.2(1) |  4.2(2) |  4.2(3) |  4.3(2) |  4.3(3) |  4.3(4) |  4.3(5) |  4.3(6) |  6.0(1)  
|  **Note** |  In a setup equipped with Cisco UCS C240 M8 Server, C220 M8 Server, and UCS X210c M8 Compute Node, you cannot downgrade Infrastructure Version (A Bundle) or Host Firmware Version (C Bundle) to any release earlier than 4.3(6a).  In a setup equipped with Cisco UCS C245 M8 Server, you cannot downgrade Infrastructure Version (A Bundle) or Host Firmware Version (C Bundle) to any release earlier than 4.3(4b).  In a setup equipped with Cisco UCS X215c M8 Compute Node and Cisco UCS C225 M8 Server, you cannot downgrade Infrastructure Version (A Bundle) or Host Firmware Version (C Bundle) to any release earlier than 4.3(5a).   
---|---  
6.0(1) |  —  |  —  |  —  |  —  |  —  |  —  |  —  |  —  |  —  |  —  |  —  |  —  |  —  |  —  |  6664, 6536, 6454, 64108  
4.3(6) |  —  |  —  |  —  |  —  |  —  |  —  |  —  |  —  |  —  |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6536, 6454, 64108  
4.3(5) |  —  |  —  |  —  |  —  |  —  |  —  |  —  |  —  |  —  |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6332, 6332-16UP, 6454, 64108, 6536 |  6536, 6454, 64108  
...
---|---  
Table 1. Minimum Host Firmware Versions for Blade Servers Servers |  Minimum Software Version  UCS 6664 FI |  Minimum Software Version  UCS 6536 FI |  Minimum Software Version  UCS 6454 FI |  Minimum Software Version  UCS 64108 FI |  Minimum Software Version  UCSX-S9108-100G |  Suggested Software Version  
---|---|---|---|---|---|---  
**UCSX-I-9108-25G** or **UCSX-I-9108-100G** |  UCS-IOM- 2408 UCSX-I-9108-25G or UCSX-I-9108-100G |  UCS-IOM- 2408 UCSX-I-9108-25G |  UCS-IOM- 2408 UCSX-I-9108-25G |  UCSX-S9108-100G  
UCS X210c M8 |  6.0(1b) |  4.3(6a) |  4.3(6a) |  4.3(6a) |  4.3(6a) |  6.0(1f)  
UCS X215c M8 |  6.0(1b) |  4.3(5a) |  4.3(5a) |  4.3(5a) |  4.3(5a) |  6.0(1f)  
UCS X410c M7 |  6.0(1b) |  4.3(2c) |  4.3(2c) |  4.3(2c) |  4.3(4b) |  6.0(1f)  
UCS X210c M7 |  6.0(1b) |  4.3(2b) |  4.3(2b) |  4.3(2b) |  4.3(4b) |  6.0(1f)  
UCS X210c M6 |  6.0(1b) |  4.3(2b) |  4.3(2b) |  4.3(2b) |  4.3(4b) |  6.0(1f)  
UCS B200 M6 |  - |  4.2(3p) |  4.2(1d) |  4.2(1d) |  - |  6.0(1f)  
UCS B200 M5 |  - |  4.2(3p) |  4.0(1a) |  4.1(1a) |  - |  6.0(1f)  
UCS B480 M5 |  - |  4.2(3p) |  4.0(1a) |  4.1(1a) |  - |  6.0(1f)  
![](https://www.cisco.com/content/dam/en/us/td/i/templates/note.gif)  
**Note** | 

* * *

  * Cisco UCS 6664 Fabric Interconnect supports only UCS X-Series Servers 
  ...
  * UCS IOM-2304v1/v2 is supported with UCS 6536 FI
  * UCS IOM-220x is supported with UCS 6400 series FI
...
---|---  
Table 2. Minimum Host Firmware Versions for Rack Servers Servers  |  Minimum Software Version  UCS 6664 FI 93180YC-FX3 (25G server ports) |  Minimum Software Version  UCS 6536 FI 93180YC-FX3 (25G server ports) 93180YC-FX3 (10G server ports) |  Minimum Software Version  UCS 6454 FI 93180YC-FX3 (25G server ports) 93180YC-FX3 (10G server ports) |  Minimum Software Version  UCS 64108 FI 93180YC-FX3 (25G server ports) 93180YC-FX3 (10G server ports) |  Suggested Software Version   
---|---|---|---|---|---  
Cisco UCS C240 M8 |  6.0(1b) |  4.3(6a) |  4.3(6a) |  4.3(6a) |  6.0(1f)  
Cisco UCS C220 M8 |  6.0(1b) |  4.3(6a) |  4.3(6a) |  4.3(6a) |  6.0(1f)  
Cisco UCS C225 M8 |  6.0(1b) |  4.3(5a) |  4.3(5a) |  4.3(5a) |  6.0(1f)  
Cisco UCS C245 M8 |  6.0(1b) |  4.3(4b) |  4.3(4b) |  4.3(4b) |  6.0(1f)  
Cisco UCS C240 M7 |  6.0(1b) |  4.3(2b) |  4.3(2b) |  4.3(2b) |  6.0(1f)  
Cisco UCS C220 M7 |  6.0(1b) |  4.3(2b) |  4.3(2b) |  4.3(2b) |  6.0(1f)  
Cisco UCS C220 M6 |  6.0(1b) |  4.2(3p) |  4.2(1d) |  4.2(1d) |  6.0(1f)  
Cisco UCS C240 M6 |  6.0(1b) |  4.2(3p) |  4.2(1d) |  4.2(1d) |  6.0(1f)  
Cisco UCS C225 M6 |  6.0(1b) |  4.2(3p) |  4.2(1l) |  4.2(1l) |  6.0(1f)  
Cisco UCS C245 M6 |  6.0(1b) |  4.2(3p) |  4.2(1i) |  4.2(1i) |  6.0(1f)  
Cisco UCS C220 M5 |  - |  4.2(3p) | 4.0(1a) |  4.1(1a) |  6.0(1f)  
Cisco UCS C240 M5 |  - |  4.2(3p) | 4.0(1a) |  4.1(1a) |  6.0(1f)  
Cisco UCS C125 M5 |  - |  4.2(3p) | 4.0(1a) |  4.1(1a) |  6.0(1f)  
Cisco UCS S3260 M5 |  - |  4.2(3p) | 4.0(1a) |  4.1(1a) |  6.0(1f)  
Cisco UCS C480 M5 ML |  - |  4.2(3p) |  4.0(2a) |  4.1(1a) |  6.0(1f)  
Cisco UCS C480 M5 |  - |  4.2(3p) | 4.0(1a) |  4.1(1a) |  6.0(1f)  
...
---|---|---  
X210c M8 |  4.3(6a) |  6.0(1f)  
X215c M8 |  4.3(5a) |  6.0(1f)  
X210c M7 |  4.3(4b) |  6.0(1f)  
X410c M7 |  4.3(4b) |  6.0(1f)  
X210c M6 |  4.3(4b) |  6.0(1f)  
...
---|---|---  
C240 M8 |  6.0(1b) |  6.0(1f)  
C220 M8 |  6.0(1b) |  6.0(1f)  
C245 M8 |  6.0(1b) |  6.0(1f)  
C225 M8 |  6.0(1b) |  6.0(1f)  
C240 M7 |  6.0(1b) |  6.0(1f)  
C220 M7 |  6.0(1b) |  6.0(1f)  
...
Table 6. Minimum Software Versions for Adapters Adapters |  Minimum Software Version UCS 6664 FI |  Minimum Software Version UCS 6664 FI |  Minimum Software Version UCS 6454 FI |  Minimum  Software Version UCS 6454 FI |  Minimum Software Version UCS 64108 FI |  Minimum Software Version UCS 6536 FI |  Minimum  Software Version UCS 6536 FI |  UCSX-S9108- 100G (Primary) |  Suggested Software Version   
---|---|---|---|---|---|---|---|---|---  
**UCSX-I-9108-25G** or **UCSX-I-9108-100G** |  93180YC-FX3 (25G server ports) |  UCS-IOM -2408 |  93180YC -FX3 (10/25G server ports) UCSX-I-9108 -25G UCSX-I-9108- 100G |  UCS-IOM -2408 UCSX-I-9108-25G UCSX-I-9108-100G |  UCS-IOM -2408 |  93180YC -FX3 (10/25G server ports) UCSX-I-9108 -25G UCSX-I-9108- 100G |  UCSX-I-9108 -25G UCSX-I-9108- 100G  
...
UCSC-M-V5Q50GV2 (Cisco UCS VIC 15427 Quad-port 10/25/50-G mLOM)  |  - |  6.0(1b) |  - |  4.3(2c) |  4.3(2c) |  - |  4.3(2c) |  - |  6.0(1f)  
UCSX-ML-V5D200GV2 (Cisco UCS VIC 15230 Dual-port 100-G mLOM)  |  6.0(1b) |  - |  - |  4.3(2c) |  4.3(2c) |  - |  4.3(2c) |  4.3(6f) |  6.0(1f)  
UCSC-M-V5D200GV2 (Cisco UCS VIC 15237 mLOM Dual-port 40/100/200-G mLOM)  |  - |  6.0(1b) |  - |  4.3(2c) |  4.3(2c) |  - |  4.3(2c) |  - |  6.0(1f)  
UCSX-ML-V5D200G (Cisco UCS VIC 15231 Dual-port 100-G mLOM) |  6.0(1b) |  - |  - |  4.3(2b) |  4.3(2b) |  - |  4.3(2b) |  4.3(6f) |  6.0(1f)  
UCSX-ME-V5Q50G (Cisco UCS VIC 15422 Quad-port 25G mezzanine) |  6.0(1b) |  - |  - |  4.3(2b) |  4.3(2b) |  - |  4.3(2b) |  - |  6.0(1f)  
UCSX-ML-V5Q50G (Cisco UCS VIC 15420 Quad-port 25G mLOM) |  6.0(1b) |  - |  - |  4.3(2b) |  4.3(2b) |  - |  4.3(2b) |  4.3(6f) |  6.0(1f)  
UCSX-V4-Q25GML (Cisco UCS VIC 14425 Quad-port 25G mLOM)  |  6.0(1b) |  - |  - |  4.3(2b) |  4.3(2b) |  - |  4.3(2b) |  4.3(6f) |  6.0(1f)  
UCSX-V4-Q25GME (Cisco VIC 14825 Quad-port 25G mezzanine)  |  6.0(1b) |  - |  - |  4.3(2b) |  4.3(2b) |  - |  4.3(2b) |  - |  6.0(1f)  
UCSC-P-V5D200G (Cisco UCS VIC 15235 Dual-port 40/100/200-G PCIe\\) |  - |  6.0(1b) |  - |  - |  - |  - |  - |  - |  6.0(1f)  
UCSC-P-V5Q50G (Cisco UCS VIC 15425 Quad-port 10/25/50-G PCIe |  - |  6.0(1b) |  - |  4.3(2b) |  - |  4.3(2b) |  4.3(2b) |  - |  6.0(1f)  
UCSC-M-V5Q50G (Cisco UCS VIC 15428 MLOM 4-port adapter) |  - |  6.0(1b) |  - |  4.2(1d) |  - |  - |  4.2(3p) |  - |  6.0(1f)  
UCSC-M-V5D200G (Cisco UCS VIC 15238 MLOM adapter) Direct Attached only |  - |  6.0(1b) |  - |  - |  - |  4.2(3p) Direct Attached only (40/100G) |  4.2(3p) Direct Attached only (40/100G) |  - |  6.0(1f)  
UCSBMLV5Q 10G  (Cisco VIC 15411) |  - |  - |  4.2(1d) |  - |  4.2(1d) |  4.2(3p) |  - |  - |  6.0(1f)  
UCSC-PCIE-C100 -04  (Cisco UCS VIC 1495) |  - |  6.0(1b) |  4.0(2a) * |  - |  4.0(2a) * |  4.2(3p) Direct Attach only (40/100G) |  4.2(3p) Direct Attach only (40/100G) |  - |  6.0(1f)  
UCSC-MLOM-C100 -04  (Cisco UCS VIC 1497) |  - |  - |  4.0(2a) * |  - |  4.0(2a) * |  4.2(3p) Direct Attach only (40/100G) |  4.2(3p) Direct Attach only (40/100G) |  - |  6.0(1f)  
UCSB-MLOM- 40G-04  (UCS VIC 1440) |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  4.2(3p) |  - |  - |  6.0(1f)  
UCSCM- V25-04 (UCS VIC 1467) |  - |  6.0(1b) |  - |  4.2(1l) |  - |  - |  4.2(3p) |  - |  6.0(1f)  
UCSC-M-V100-04 (UCS VIC 1477) |  - |  6.0(1b) |  - |  - |  - |  4.2(3p) Direct Attached only |  - |  6.0(1f)  
UCSB-VIC- M84-4P  (UCS VIC 1480) |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  4.2(3p) |  - |  - |  6.0(1f)  
UCSC-PCIE- C25Q-04  (UCS VIC 1455) |  - |  6.0(1b) |  4.0(1a) * |  4.2(3p) |  4.1(1a) * |  - |  4.2(3p) |  - |  6.0(1f)  
UCSC-MLOM- C25Q-04  (UCS VIC 1457) |  - |  - |  4.0(1a) * |  4.2(3p) |  4.1(1a) * |  - |  4.2(3p) |  - |  6.0(1f)  
UCSC-PCIE-C40Q -03 (UCS VIC 1385) UCSC-MLOM-C40Q -03 (UCS VIC 1387) |  - |  - |  4.0(1a) * |  4.2(3p) |  4.1(1a) * |  - |  4.2(3p) |  - |  6.0(1f)  
UCSB-MLOM- 40G-03 (UCS VIC 1340) UCSB-VIC- M83-8P (UCS VIC 1380) |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  4.2(3p) |  - |  - |  6.0(1f)  
UCSC-PCIE -BD16GF (Emulex LPe31002 Dual-Port 16G FC HBA) |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(1f)  
UCSC-PCIE -ID40GF (Intel XL710 adapter) |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(1f)  
UCSC-PCIE -IQ10GF (Intel X710-DA4 Quad Port 10G Ethernet PCIe adapter) |  - |  - |  4.0(1a)* |  - |  4.1(1a)* |  - |  - |  - |  6.0(1f)  
UCSC-PCIE -ID10GF (Intel X710-DA2 Dual Port 10G Ethernet PCIe adapter) |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(1f)  
UCSC-PCIE -ID40GF: Intel XL710-QDA2 Dual port 40 Gigabit  Ethernet PCIe adapter  |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(1f)  
UCSC-PCIE -ID25GF (Intel XXV710-DA2 Dual port 25 Gigabit Ethernet PCIe adapter) |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(1f)  
UCSC-PCIE -ID10GC (Intel X550-T2 adapter) |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(1f)  
N2XX-AIPCI01 (Intel X520 dual port adapter) |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(1f)  
UCSC-PCIE-IRJ45:  Intel Ethernet Server Adapter I350-T4 |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(1f)  
UCSC-MLOM-IRJ45:  Intel Ethernet I350-mLOM 1 Gbps Network Controller |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(1f)  
UCSC-PCIE -ID25GF (Intel X710 25Gb Dual-port BaseT) |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(1f)  
UCSC-PCIE -IQ10GC (Intel X710-T4) |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(1f)  
UCSC-PCIE -IQ10GF (Intel X710-DA4 adapter) UCSC-PCIE -ID40GF (Intel XL710 adapter) |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(1f)  
UCSC-PCIE -BD32GF (Emulex LPe32002) UCSC-PCIE -BS32GF (Emulex LPe32000 Single-Port 32G FC HBA) |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(1f)  
UCSC-PCIE -E16002 (Emulex LPe16002-M6 16G FC rack HBA) |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(1f)  
UCSC-PCIE -ID10GC (Intel X550 Dual-port 10GBase-T NIC) |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(1f)  
UCSC-O -ID25GF (Intel XXV710 - DA2 - OCP1 2x25/10GbE OCP 2.0 adapter) |  - |  - |  4.0(1a) * |  - |  4.0(1a) * |  - |  - |  - |  6.0(1f)  
UCSC-P -Q6D32GF (Cisco-QLogic QLE2772 2x32GFC Gen 6 Enhanced PCIe HBA) |  - |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  - |  6.0(1f)  
UCSC-P -B7D32GF (Cisco-Emulex LPe35002-M2-2x32GFC Gen 7 PCIe HBA) |  - |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  - |  6.0(1f)  
UCSC-P -I8D100GF(Cisco - Intel E810CQDA2 2x100 GbE QSFP28 PCIe NIC) |  - |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  - |  6.0(1f)  
UCSC-P -I8Q25GF (Cisco - Intel E810XXVDA4 4x25/10 GbE SFP28 PCIe NIC) |  - |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  - |  6.0(1f)  
UCSC-P -I8D25GF (Cisco - Intel E810XXVDA2 2x25/10 GbE SFP PCIe NIC) |  - |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  - |  6.0(1f)  
UCSC-P -ID10GC (Cisco - Intel X710T2LG 2x10 GbE RJ45 PCIe NIC) |  - |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  - |  6.0(1f)  
UCSC-O -ID10GC: Cisco(R) X710T2LG 2x10 GbE  RJ45 OCP 3.0 NIC |  - |  - |  4.2(1d) |  4.2(1d) |  4.2(1d) |  4.2(1d) |  4.2(1d) |  - |  6.0(1f)  
...
UCSB-RAID12G-M6:  Cisco FlexStorage 12G SAS  RAID Controller |  - |  - |  4.2(1d) |  4.2(1d) |  4.2(1d) |  4.2(1d) |  4.2(1d) |  - |  6.0(1f)  
UCSC-SAS-M6T:  Cisco M6 12G SAS HBA for (16 Drives)  |  - |  - |  4.2(1d) |  4.2(1d) |  4.2(1d) |  4.2(1d) |  4.2(1d) |  - |  6.0(1f)  
UCSX-X10C-RAIDF:  UCS X10c Compute RAID Controller |  - |  - |  - |  - |  - |  - |  - |  - |  6.0(1f)  
Cisco Mini Storage Carrier for M.2 SATA-SWRAID Mode |  - |  - |  4.2(1d) |  4.2(1d) |  4.2(1d) |  4.2(1d) |  4.2(1d) |  - |  6.0(1f)  
Cisco UCSC-P-M5S100GF (Mellanox ConnectX-5 MCX515A-CCAT 1 x 100GbE QSFP PCI NIC) |  - |  - |  4.1(1a) |  - |  4.1(1a) |  - |  - |  - |  6.0(1f)  
Cisco UCSC-P-M5D25GF (Mellanox ConnectX-5 MCX512A-ACAT 2 x 25Gb/10GbE SFP PCI) |  - |  - |  4.1(1a) |  - |  4.1(1a) |  - |  - |  - |  6.0(1f)  
Cisco UCSC-O-M5S100GF (Mellanox ConnectX-5 MCX545B-ECAN 1 x 100GbE QSFP PCI NIC) |  - |  - |  4.1(1a) |  - |  4.1(1a) |  - |  - |  - |  6.0(1f)  
Cisco UCSC-PCIE-QS100GF (QLogic R FastLinQ QL45611H 100GbE) |  - |  - |  4.0(4o) |  - |  4.1(1a) |  - |  - |  - |  6.0(1f)  
Cisco UCSC-PCIE-QD40GF (QLogic QL45412H 40GbE) |  - |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  - |  6.0(1f)  
Cisco UCSC-PCIE-QD16GF (QLogic QLE2692 16GB dual Port FC HBA) |  - |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  - |  6.0(1f)  
Cisco UCSC-PCIE-QD25GF (QLogic FastLinQ QL41212H 25GbE adapter) |  - |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  - |  6.0(1f)  
Cisco UCSC-OCP-QD25GF (QLogic FastLinQ QL41232H Dual Port 25GbE Adapter) |  - |  - |  4.0(1a) |  - |  4.0(1a) |  - |  - |  - |  6.0(1f)  
Cisco UCSC-OCP-QD10GC (QLogic FastLinQ QL41132H Dual Port 10GbE Adapter) |  - |  - |  4.0(1a) |  - |  4.0(1a) |  - |  - |  - |  6.0(1f)  
Cisco UCSC-PCIE-QD10GC (Qlogic QL41162HLRJ-11-SP dual-port 10GBase-T CNA) |  - |  - |  4.0(2a) |  - |  4.0(2a) |  - |  - |  - |  6.0(1f)  
Cisco UCSB-MLOM-PT-01 (Cisco Port Expander Card) |  - |  - |  4.0(1a) |  - |  4.0(1a) |  - |  - |  - |  6.0(1f)  
Cisco UCSC-PCIE-QD32GF (Qlogic QLE2742 Dual Port 32Gb FC HBA) |  - |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  - |  6.0(1f)  
![](https://www.cisco.com/content/dam/en/us/td/i/templates/note.gif)  
**Note** | 
...
## Cisco UCS Fabric Interconnect Server Compatibility Matrix - Release 6.0(1f)

### Cisco UCS 6664 FI

Table 7. Cisco UCS 6664 FI \- Cisco UCS Rack Servers Cisco VIC |  Direct Attach (100G) |  Direct Attach (25G QSA28 at FI on 100G ports) |  Direct Attach (25G on FI unified port) |  93180YC-FX3 (25G server ports)  
---|---|---|---|---  
15235 (UCSC-P-V5D200G) |  All Cisco UCS C-Series M6, M7, and M8 servers |  Not Supported  |  Not Supported  |  Not Supported   
15237 (UCSC-M-V5D200GV2) |  All Cisco UCS C-Series M6, M7, and M8 servers |  Not Supported  |  Not Supported  |  Not Supported   
15238 (UCSC-M-V5D200G) |  All Cisco UCS C-Series M6 and M7 servers |  Not Supported  |  Not Supported  |  Not Supported   
15425 (UCSC-P-V5Q50G) |  Not Supported  |  All Cisco UCS C-Series M6, M7, and M8 servers |  All Cisco UCS C-Series M6, M7, and M8 servers |  All Cisco UCS C-Series M6, M7, and M8 servers  
15427 (UCSC-M-V5Q50GV2) |  Not Supported  |  All Cisco UCS C-Series M6, M7, and M8 servers |  All Cisco UCS C-Series M6, M7, and M8 servers |  All Cisco UCS C-Series M6, M7, and M8 servers  
VIC 15428 (UCSC-M-V5Q50G) |  Not Supported  |  All Cisco UCS C-Series M6 and M7 servers |  All Cisco UCS C-Series M6 and M7 servers |  All Cisco UCS C-Series M6 and M7 servers  
1477 (UCSC-M-V100-04) |  All Cisco UCS C-Series M6 servers |  Not Supported  |  Not Supported  |  Not Supported   
1495 (UCSC-PCIE-C100-04) |  All Cisco UCS C-Series M6 servers |  Not Supported  |  Not Supported  |  Not Supported   
1467 (UCSC-M-V25-04) |  Not Supported  |  All Cisco UCS C-Series M6 servers |  All Cisco UCS C-Series M6 servers |  All Cisco UCS C-Series M6 servers  
1455 (UCSC-PCIE-C25Q-04) |  Not Supported  |  All Cisco UCS C-Series M6 servers |  All Cisco UCS C-Series M6 servers |  All Cisco UCS C-Series M6 servers  
Table 8. Cisco UCS 6664 FI \- Cisco UCS Blade Servers Cisco VIC |  IOM  (UCSX-I-9108-25G or UCSX-I-9108-100G)  
---|---  
...
Table 9. Cisco UCS 6536 FI - Cisco UCS Rack Servers Cisco VIC |  Direct Attach  (40/100G) |  Direct Attach  (4x25G or 25G QSA28) |  FEX  
---|---|---|---  
...
Table 10. Cisco UCS 6536 FI - Cisco UCS Blade Servers Cisco VIC |  IOM  
---|---  
...
Table 11. Cisco UCS 6400 and 64108 FIs - Cisco UCS Rack Servers Cisco VIC |  Direct Attach  (10G/25G)  |  Direct Attach  (4x10G/4x25)  |  Direct Attach  (40G/100G)  |  FEX  
---|---|---|---|---  
...
Table 12. Cisco UCS 6400 and 64108 FIs - Cisco UCS Blade Servers Cisco VIC |  IOM  
---|---  
...
Table 13. Cisco UCS FI 9108 100G - Cisco UCS Blade Servers Cisco VIC |  UCSX-S9108-100G (Primary Chassis)  
---|---  
14425 (UCSX-V4-Q25GML) |  Cisco UCS X210c M6  
14425 + UCS VIC 14000 bridge connector + 14825  (UCSX-V4-Q25GML + UCSX-V4-BRIDGE +  UCSX-V4-Q25GME) |  Cisco UCS X210c M6  
