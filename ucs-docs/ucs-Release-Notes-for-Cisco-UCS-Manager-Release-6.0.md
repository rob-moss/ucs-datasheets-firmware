...
| **File type** | HTML |
| **Fetched on** | 2026-08-24 11:19:29 |
...
## Contents
  ...
  * New Hardware in Release 6.0(2d)
  * New Hardware in Release 6.0(2c)
  ...
  * Security Fixes
  * Security Fixes in Release 6.0(2d)
  * Security Fixes in Release 6.0(2c)
  ...
  * Resolved Caveats
  * Resolved Caveats in Release 6.0(2d)
  * Resolved Caveats in Release 6.0(2c)
  ...
  * Open Caveats
  * Open Caveats in Release 6.0(2d)
  * Open Caveats in Release 6.0(2c)
  ...
  * Known Behavior and Limitations in Release 6.0(2d)
  * Known Behavior and Limitations in Release 6.0(2c)
...
---|---|---  
6.0(2d) |  June 25, 2026 |  Created release notes for Cisco UCS Manager Release 6.0(2d).   
6.0(2c) |  April 23, 2026 |  Created release notes for Cisco UCS Manager Release 6.0(2c).   
...
### New Software Features
  ...
  * New Software features in Release 6.0(2d)\- None 

  * New Software features in Release 6.0(2c)\- None 
...
Following peripherals are supported from release 6.0(2d) onwards: 

  * NVIDIA RTX Pro 4500 GPU 160W 32GB Gen5 FHFL 1-slot (UCSX-GPU-RTXP4500) with Cisco UCS C245 M8 and C240 M8 servers.

  * NVIDIA RTX Pro 6000D GPU 600W, 84GB, 2-slot FHFL PCIe GPU (UCSC-GPU-RTX6000D) with Cisco UCS C240 M8 servers.
...
Following peripherals are supported from release 6.0(2c) onwards: 

  * NVIDIA OEM BlueField-3 B3220 DPU 2x200G QSFP112, Crypto Disabled (UCSC-P-N3220) with Cisco UCS C240 M7, C245 M8 and C240 M8 servers 

  * NVIDIA BlueField-3 B3220L SuperNIC 2x200G QSFP112, PCIe Gen5.0 x16, Crypto Disabled (UCSC-P-N3220L) with Cisco UCS C240 M7, C225 M8, C245 M8 , C220 M8 and C240 M8 servers 

  * Support for 30 TB E3.S TLC Micron 9550 drive on Cisco UCS C240, C220, X215c, and X210c M8 servers

  * Support for E3.S FIPS (Kioxia CM-7) drives on Cisco UCS C240, C220, X215c, and X210c M8 servers
...
Following peripherals are supported from release 6.0(2b) onwards: 
  ...
  * Support for NVIDIA RTX Pro 6000 (UCSC-GPU-RTXP6000) with Cisco UCS C240 M8 servers
...
There are no new security fixes in release 6.0(2d). 

## Security Fixes in Release 6.0(2c)

There are no new security fixes in release 6.0(2c). 
...
The following caveats are resolved in release 6.0(1h): 
...
There are no new open caveats in release 6.0(2d). 

## Open Caveats in Release 6.0(2c)

The following caveat is open in release 6.0(2c): 

Defect ID |  Symptom |  Workaround |  First Bundle Affected  
---|---|---|---  
CSCws49799 |  In certain scenarios involving drive hot-plug and VM lifecycle operations, NVMe drives may appear as degraded in the out-of-band (OOB) management interface despite) management interface despite showing no errors on the host and functioning normally within the VM. This condition can persist even after drives are removed, reseated, and reassigned.  |  There is no known workaround. |  6.0(2b)  
CSCwt98100 |  In UCS X-Series Direct, downgrading from release 6.0(2c) with AES encryption enabled to any 4.3(4a) patch release is not supported. AES encryption must be enabled in 6.0(2c) for this issue to occur, and there is no option to disable AES encryption in this release. Attempts to downgrade under these conditions fail with an error indicating the downgrade path is unsupported.  |  There is no known workaround. |  6.0(2c)  
...
CSCwt35920 |  Certain RTX Pro 6000 GPUs shipped as spares may experience a firmware update discrepancy. Although the Host Update Utility (HUU) reports that the update has completed successfully, the GPU firmware version on these specific units remains unchanged. This issue is restricted to select spare components and does not impact the standard update process for other hardware.  |  There is no known workaround. |  6.0(2b)  
...
6.0(1b)  
CSCwt18924 |  After an upstream Cisco ACI fabric upgrade or reload, Cisco UCS VIC adapters may fail to bring vNICs online. The adapter physical interfaces come up, but the vNICs remain stuck in an initializing state and do not recover automatically. Adapter logs may show the adapter encountering out-of-memory conditions, followed by a reset.  This issue is observed with 10GBase-T (10G-T-X) transceivers on Cisco UCS VIC 1400 Series and 15000 Series adapters and may be triggered during switch or server reload events when the transceiver holds the I2C bus, leading to a memory leak in the adapter.  |  There is no known workaround. |  4.3(5a)  
  
### Known Behavior and Limitations

## Known Behavior and Limitations in Release 6.0(2d)

There are no new know limitations in release 6.0(2d). 

## Known Behavior and Limitations in Release 6.0(2c)

There are no new know limitations in release 6.0(2c). 
...
PowerStore, PowerMax |  Cisco UCS 6400 series, Cisco UCS 6536 FI |  1400/14000, 15000 |  ESXi 8.0 U3+, ESXi 9.0+, RHEL 9.6+, RHEL 10+, SLES 15SP5+  
PowerStore, PowerMax |  Cisco UCS X-Direct |  15000 |  ESXi 8.0 U3+, ESXi 9.0+, RHEL 9.6+, RHEL 10+, SLES 15SP5+  
Hitachi, Ltd. ® |  NVMe-TCP |  Hitachi VSP One Block 85 |  UCSX S9108 (EHM) |  15000 |  ESXI 9.0+   
...
---|---|---  
Cisco UCS 9108-100G  | 4.3(4b) |  6.0(2d)  
Extended Chassis UCS X9508 |  6.0(1b) |  6.0(2d)  
...
---|---|---|---|---  
NVIDIA RTX Pro 6000 GPU 600W 96GB 2-slot FHFL |  UCSC-GPU-RTXP6000 |  Cisco UCS C240 M8 |  6.0(2b) |  6.0(2d)  
NVIDIA A16 GPU on X440p: PCIE 250W 4X16GB, FHFL  |  UCSX-GPU-A16 |  Cisco UCS X210c M8 (with PCIe Node)  |  4.3(6a) |  6.0(2d)  
UCSC-GPU-A16 |  Cisco UCSX215c M8 (with PCIe Node)  |  4.3(5a) |  6.0(2d)  
AMD MI210 GPU; 300W 64GB, 2 slot FHFL |  UCSX-GPU-MI210 |  Cisco UCS X215c M8 |  4.3(6a) |  6.0(2d)  
NVIDIA H100-NVL GPU 400W, 94GB, 2-slot FHFL  |  UCSX-GPU-H100-NVL |  Cisco UCS X210c M8 (with PCIe Node)  |  4.3(6a) |  6.0(2d)  
UCSC-GPU-H100-NVL |  Cisco UCS C240 M8 |  4.3(6a) |  6.0(2d)  
Cisco UCS X210c M7 Cisco UCS X215c M8 (with PCIe Node)  |  4.3(5a) |  6.0(2d)  
Cisco UCS C245 M8 |  4.3(5a) |  6.0(2d)  
Cisco UCS C240 M7 |  4.3(5a) |  6.0(2d)  
NVIDIA L4-Mezz GPU 70W, 24GB, 1-slot HHHL |  UCSX-GPU-L4-Mezz |  Cisco UCS X210c M7 Cisco UCS X215c M8 |  4.3(5a) |  6.0(2d)  
UCSX-440P-D GPU PCIe Node |  UCSX-440P-D |  Cisco UCS X210c M7, X210c M6, and X410c M7 |  4.3(4a) |  6.0(2d)  
Intel GPU Flex 140, Gen4x8, HHHL, 75W PCIe (Front Mezz) |  UCSX-GPU-FLX140MZ |  Cisco UCS X210c M7 |  4.3(2b) |  6.0(2d)  
Intel GPU Flex 140, Gen4x8, HHHL, 75W PCIe |  UCSX-GPU-FLEX140 |  Cisco UCS X410c M7 and X210c M7 (with PCIe Node) |  4.3(4a) |  6.0(2d)  
UCSC-GPU-FLEX140 |  Cisco UCS C220 M7 and C240 M7 |  4.3(4a) |  6.0(2d)  
Intel GPU Flex 170, Gen4x16, HHFL, 150W PCIe |  UCSX-GPU-FLEX170 |  Cisco UCS X410c M7 and X210c M7 (with PCIe Node) |  4.3(4a) |  6.0(2d)  
UCSC-GPU-FLEX170 |  Cisco UCS C240 M7 |  4.3(4a) |  6.0(2d)  
NVIDIA TESLA A16 PCIE 250W 4X16GB |  UCSX-GPU-A16-D |  Cisco UCS X210c M7 and X210c M6 (with PCIe Node) |  4.3(4a) |  6.0(2d)  
Cisco UCS X410c M7 (with PCIe Node) |  4.3(4a) |  6.0(2d)  
UCSC-GPU-A16 |  Cisco UCS C240 M8 |  4.3(6a) |  6.0(2d)  
Cisco UCS C240 M6 |  4.2(1d) |  6.0(2d)  
Cisco UCS C245 M6 |  4.2(1i) |  6.0(2d)  
NVIDIA L4 Tensor Core, 70W, 24GB |  UCSX-GPU-L4 |  Cisco UCS X210c M8 (with PCIe Node)  |  4.3(6a) |  6.0(2d)  
Cisco UCS X210c M7 (with PCIe Node) |  4.3(4a) |  6.0(2d)  
Cisco UCS X410c M7 (with PCIe Node) |  4.3(4a) |  6.0(2d)  
NVIDIA L40 300W, 48GB wPWR CBL |  UCSX-GPU-L40 |  Cisco UCS X210c M7 (with PCIe Node) |  4.3(4a) |  6.0(2d)  
Cisco UCS X410c M7 (with PCIe Node) |  4.3(4a) |  6.0(2d)  
UCSC-GPU-L40 |  Cisco UCS C240 M7 |  4.3(2b) |  6.0(2d)  
Cisco UCS X215c M8 (with PCIe Node)  |  4.3(5a) |  6.0(2d)  
NVIDIA L40S: 350W, 48GB, 2-slot FHFL GPU |  UCSX-GPU-L40S | Cisco UCS X210c M8 (with PCIe Node)  |  4.3(6a) |  6.0(2d)  
Cisco UCS X210c M7 (with PCIe Node) Cisco UCS X410c M7 (with PCIe Node) |  4.3(4a)  
UCSC-GPU-L40S | Cisco UCS C240 M8 |  4.3(6a) |  6.0(2d)  
Cisco UCS C240 M7 |  4.3(4a) |  6.0(2d)  
Cisco UCS X215c M8 (with PCIe Node)  |  4.3(5a) |  6.0(2d)  
NVIDIA T4 PCIE 75W 16GB |  UCSX-GPU-T4-16 |  Cisco UCS X210c M6 (with PCIe Node) |  4.3(4a) |  6.0(2d)  
UCSC-GPU-T4-16 |  Cisco UCS C220 M6 |  4.3(2b) |  6.0(2d)  
Cisco UCS C245 M6 |  4.2(1f) |  6.0(2d)  
Cisco UCS C225 M6 |  4.2(1l) |  6.0(2d)  
Cisco UCS C240 M5, C220 M5, and C480 M5 |  3.2(3a) |  6.0(2d)  
Cisco UCS S3260 M5 |  3.1(2b) |  6.0(2d)  
NVIDIA T4 GPU PCIE 75W 16GB, MEZZ form factor (Front Mezz) |  UCSX-GPU-T4-MEZZ |  Cisco UCS X210c M7 and X210c M6 |  4.3(2b) |  6.0(2d)  
NVIDIA Hopper L4 70W, 24GB, 1-slot HHHL |  UCSC-GPU-L4M6 |  Cisco UCS C220 M6, C240 M6 |  4.3(4a) |  6.0(2d)  
NVIDIA H100: 350W, 80GB, 2-slot FHFL GPU |  UCSX-GPU-H100-80 |  Cisco UCS X210c M7 and X410c M7 (with PCIe Node) |  4.3(4a) |  6.0(2d)  
UCSC-GPU-H100-80 |  Cisco UCS C240 M7 |  4.3(4a) |  6.0(2d)  
NVIDIA L4:70W, 24GB, 1-slot HHHL GPU |  UCSC-GPU-L4 |  Cisco UCS C240 M8 and C220 M8 |  4.3(6a) |  6.0(2d)  
Cisco UCS C245 M8 |  4.3(5a) |  6.0(2d)  
Cisco UCS C220 M7 and C240 M7 |  4.3(2b) |  6.0(2d)  
Cisco UCS X215c M8 (with PCIe Node)  |  4.3(5a) |  6.0(2d)  
NVIDIA P4 |  UCSC-GPU-P4 |  Cisco UCS C220 M5 |  3.2(3a) |  6.0(2d)  
NVIDIA M10 |  UCSC-GPU-M10 |  Cisco UCS C240 M5 and C480 M5 |  3.2(3a) |  6.0(2d)  
NVIDIA GRID P6 Front Mezzanine |  UCSB-GPU-P6-F |  Cisco UCS B200 M5 |  3.2(1d) |  6.0(2d)  
Cisco UCS B480 M5 |  3.2(2b) |  6.0(2d)  
NVIDIA GRID P6 Rear Mezzanine |  UCSB-GPU-P6-R |  Cisco UCS B200 M5 |  3.2(1d) |  6.0(2d)  
Cisco UCS B480 M5 |  3.2(2b) |  6.0(2d)  
TESLA A30, PASSIVE, 180W, 24GB |  UCSC-GPU-A30-D |  Cisco UCS C240 M7 |  4.3(2b) |  6.0(2d)  
UCSC-GPU-A30 |  Cisco UCS C240 M6 |  4.2(1d) |  6.0(2d)  
Cisco UCS C245 M6 |  4.2(1i) |  6.0(2d)  
TESLA A40 RTX, PASSIVE, 300W, 48GB |  UCSX-GPU-A40-D |  Cisco UCS X210c M7 and X210c M6 (with PCIe Node) |  4.3(4a) |  6.0(2d)  
Cisco UCS X410c M7 (with PCIe Node) |  4.3(4a) |  6.0(2d)  
UCSC-GPU-A40-D |  Cisco UCS C240 M7 |  4.3(2b) |  6.0(2d)  
UCSC-GPU-A40 |  Cisco UCS C240 M6 |  4.2(1d) |  6.0(2d)  
Cisco UCS C245 M6 |  4.2(1i) |  6.0(2d)  
Cisco UCS C480 M5 |  3.2(3a) |  6.0(2d)  
TESLA A100, PASSIVE, 300W, 80GB12 |  UCSX-GPU-A100-80-D |  Cisco UCS X210c M7 and X210c M6 (with PCIe Node) |  4.3(4a) |  6.0(2d)  
Cisco UCS X410c M7 (with PCIe Node ) |  4.3(4a) |  6.0(2d)  
UCSC-GPUA100-80-D |  Cisco UCS C240 M7 |  4.3(2b) |  6.0(2d)  
UCSC-GPU-A100-80 |  Cisco UCS C240 M6 |  4.2(1d) |  6.0(2d)  
Cisco UCS C245 M6 |  4.2(1i) |  6.0(2d)  
All Cisco UCS C-Series M5 |  4.2(2c) |  6.0(2d)  
TESLA A10, PASSIVE, 150W, 24GB |  UCSC-GPU-A10 |  Cisco UCS C240 M6 |  4.2(1d) |  6.0(2d)  
Cisco UCS C245 M6 |  4.2(1i) |  6.0(2d)  
NVIDIA H200-NVL GPU |  UCSC-GPU-H200-NVL |  Cisco UCS C240 M8 |  4.3(6c) |  6.0(2d)  
...
---|---|---  
6.0(2d) |  ucs-catalog.6.0.2d.T.bin |  GPU:

  * UCSX-GPU-RTXP4500 UCSC-GPU-RTX6000D

  
6.0(2c) |  ucs-catalog.6.0.2c.T.bin |  Peripherals:

  * UCSC-P-N3220L (Crypto disabled)
  * UCSC-P-N3220 (Crypto disabled)
...
Cisco UCS X410c M8 Compute Node: UCSX-410c-M8  Peripherals:
...
## Contents
  ...
  * New Hardware in Release 4.2(3s)
  ...
  * New Software Features in Release 4.2(3s)
  ...
  * Capability Catalog
  * Security Fixes
  * Security Fixes in Release 4.2(3s)
  ...
  * Resolved Caveats
  * Resolved Caveats in Release 4.2(3s)
  ...
  * Open Caveats
  * Open Caveats for Release 4.2(3s)
...
---|---|---  
4.2(3s) |  August 05, 2026 |  Created release notes for Cisco UCS Manager Release 4.2(3s).   
4.2(3r) |  April 14, 2026 |  Created release notes for Cisco UCS Manager Release 4.2(3r).   
...
B200 M6 |  N/A | 4.2(1d) | 4.2(1d) | 4.2(1d) | 4.2(1d) | 4.2(1d) | 4.2(3b) |  4.2(3s)  
B200 M5  |  3.2(1d) |  3.2(1d) |  3.2(1d) |  4.0(4o) |  4.0(1a) |  4.1(1a) | 4.2(3b) |  4.2(3s)  
B480 M5 |  3.2(2b) |  3.2(2b) |  3.2(2b) |  4.0(4o) |  4.0(1a) |  4.1(1a) | 4.2(3b) |  4.2(3s)  
B200 M4  |  2.2(8a)  |  3.1(3a)  |  3.1(3a)  |  4.0(4o) |  4.0(1a) |  4.1(1a) | 4.2(3b) |  4.2(3s)  
B260 M4 E7-2800 v2  B260 M4 E7-4800 v2  B260 M4 E7-8800 v2  B260 M4 E7-4800 v3  B260 M4 E7-8800 v3  |  2.2(8a) 2.2(8a) 2.2(8a) 2.2(8a) 2.2(8a) |  3.1(3a)  3.1(3a)  3.1(3a)  3.1(3a)  3.1(3a)  |  3.1(3a)  |  4.0(4o) |  4.0(1a) |  4.1(1a) | 4.2(3b) |  4.2(3s)  
B260 M4 E7-4800 v4  B260 M4 E7-8800 v4  |  2.2(8b)  2.2(8b)  |  3.1(3a)  3.1(3a)  |  3.1(3a)  3.1(3a)  |  4.0(4o) |  4.0(1a) |  4.1(1a) | 4.2(3b) |  4.2(3s)  
B420 M4 E5-4600 v3  B420 M4 E5-4600 v4  |  2.2(8a) 2.2(8b)  |  3.1(3a)  3.1(3a)  |  3.1(3a)  3.1(3a)  |  4.0(4o) |  4.0(1a) |  4.1(1a) | 4.2(3b) |  4.2(3s)  
B460 M4 E7-4800 v2  B460 M4 E7-8800 v2  B460 M4 E7-4800 v3  B460 M4 E7-8800 v3  |  2.2(8a) 2.2(8a) 2.2(8a) 2.2(8a) |  3.1(3a)  3.1(3a)  3.1(3a)  3.1(3a)  |  3.1(3a)  |  4.0(4o) |  4.0(1a) |  4.1(1a) | 4.2(3b) |  4.2(3s)  
B460 M4 E7-4800 v4  B460 M4 E7-8800 v4  |  2.2(8b)  2.2(8b)  |  3.1(3a)  3.1(3a)  |  3.1(3a)  |  4.0(4o) |  4.0(1a) |  4.1(1a) | 4.2(3b) |  4.2(3s)  
...
C220 M6  |  N/A |  4.2(1d) |  4.2(1d) |  4.2(1d) |  4.2(3b) |  4.2(3s)  
C240 M6  |  N/A |  4.2(1d) |  4.2(1d) |  4.2(1d) |  4.2(3b) |  4.2(3s)  
C225 M6 |  N/A |  4.2(1l) |  4.2(1l) |  4.2(1l) |  4.2(3b) |  4.2(3s)  
C245 M6 |  N/A |  4.2(1i) |  4.2(1i) |  4.2(1i) |  4.2(3b) |  4.2(3s)  
C220 M5  |  3.2(1d) |  3.2(1d) | 4.0(1a) |  4.1(1a) |  4.2(3b) |  4.2(3s)  
C240 M5  |  3.2(1d) |  3.2(1d) | 4.0(1a) |  4.1(1a) |  4.2(3b) |  4.2(3s)  
C125 M5 |  NA | 4.0(1a) | 4.0(1a) |  4.1(1a) |  4.2(3b) |  4.2(3s)  
S3260 M5 |  3.2(3a) |  3.2(3a) | 4.0(1a) |  4.1(1a) |  4.2(3b) |  4.2(3s)  
C220 M4  |  2.2(8a) |  3.1(3a)  | 4.0(1a) |  4.1(1a) |  4.2(3b) |  4.2(3s)  
C240 M4  |  2.2(8a) |  3.1(3a)  | 4.0(1a) |  4.1(1a) |  4.2(3b) |  4.2(3s)  
C460 M4 E7-2800 v2  C460 M4 E7-4800 v2  C460 M4 E7-8800 v2  C460 M4 E7-4800 v3  C460 M4 E7-8800 v3  |  2.2(8a) 2.2(8a) 2.2(8a) 2.2(8a) 2.2(8a) |  3.1(3a)  3.1(3a)  3.1(3a)  3.1(3a)  3.1(3a)  | 4.0(1a) |  4.1(1a) |  4.2(3b) |  4.2(3s)  
C460 M4 E7-8800 v4  |  2.2(8b)  |  3.1(3a)  | 4.0(1a) |  4.1(1a) |  4.2(3b) |  4.2(3s)  
C480 M5 |  3.2(2b) |  3.2(2b) | 4.0(1a) |  4.1(1a) |  4.2(3b) |  4.2(3s)  
S3260 M4 |  3.1(2b) |  3.1(3a)  | 4.0(1a) |  4.1(1a) |  NA |  4.2(3s)  
...
UCSC-M-V5Q50G (Cisco UCS VIC 15428 MLOM 4-port adapter) |  - |  - |  - |  4.2(1d) |  - |  4.2(1d) |  - |  - |  4.2(3b) |  4.2(3s)  
UCSC-M-V5D200G (Cisco UCS VIC 15238 MLOM adapter) Direct Attached only |  - |  4.2(3b) Direct Attached only |  4.2(3b) Direct Attached only  |  4.2(3b) Direct Attached only |  - |  - |  - |  4.2(3b) Direct Attached only (40/100G) |  4.2(3b) Direct Attached only (40/100G) |  4.2(3s)  
UCSBMLV5Q 10G  (Cisco VIC 15411) |  - |  4.2(1d) |  4.2(1d) |  - |  4.2(1d) |  - |  4.2(1d) |  4.2(3b) |  - |  4.2(3s)  
UCSC-PCIE-C100 -04  (Cisco UCS VIC 1495) |  4.0(2a) |  4.0(2a) |  4.0(2a) |  - |  4.0(2a) |  - |  4.0(2a) |  4.2(3b) Direct Attach only (40/100G) |  4.2(3b) Direct Attach only (40/100G) |  4.2(3s)  
UCSC-MLOM-C100 -04  (Cisco UCS VIC 1497) |  4.0(2a) |  4.0(2a) |  4.0(2a) |  - |  4.0(2a) |  - |  4.0(2a) |  4.2(3b) Direct Attach only (40/100G) |  4.2(3b) Direct Attach only (40/100G) |  4.2(3s)  
UCSB-MLOM- 40G-04  (UCS VIC 1440) |  4.0(1a) |  4.0(1a) |  4.0(1a) |  - |  4.0(1a) |  - |  4.1(1a) |  4.2(3b) |  - |  4.2(3s)  
UCSCM- V25-04 (UCS VIC 1467) |  - |  - |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  4.2(3b) |  4.2(3s)  
UCSC-M-V100-04 (UCS VIC 1477) |  - |  4.2(1l)Direct Attached only  |  - |  - |  - |  4.2(3b) Direct Attached only |  4.2(3s)  
UCSB-VIC- M84-4P  (UCS VIC 1480) | 4.0(1a) | 4.0(1a) | 4.0(1a) |  - |  4.0(1a) |  - |  4.1(1a) |  4.2(3b) |  - |  4.2(3s)  
UCSC-PCIE- C25Q-04  (UCS VIC 1455) | 4.0(1a) | 4.0(1a) |  4.0(1a) |  4.0(1a) |  4.0(1a) |  4.0(1a) |  4.1(1a) |  - |  4.2(3b) |  4.2(3s)  
UCSC-MLOM- C25Q-04  (UCS VIC 1457) | 4.0(1a) | 4.0(1a) | 4.0(1a) |  4.0(1a) |  4.0(1a) |  4.0(1a) |  4.1(1a) |  - |  4.2(3b) |  4.2(3s)  
UCSC-PCIE-C40Q -03 (UCS VIC 1385) UCSC-MLOM-C40Q -03 (UCS VIC 1387) |  2.2(8a)  |  3.1(3a)  |  3.1(3a)  |  4.0(1a) |  4.0(1a) |  4.0(1a) |  4.1(1a) |  - |  4.2(3b) |  4.2(3s)  
UCSB-MLOM- 40G-03 (UCS VIC 1340) UCSB-VIC- M83-8P (UCS VIC 1380) UCSC-MLOM-CSC -02 (UCS VIC 1227) |  2.2(8a) |  3.1(3a)  |  3.1(3a)  |  - |  4.0(1a) |  - |  4.1(1a) |  4.2(3b) |  - |  4.2(3s)  
UCSC-PCIE-CSC-02 (UCS VIC 1225) |  2.2(8a) |  3.1(3a)  |  3.1(3a)  |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  -  
UCSC-P- M5S100GF (Mellanox ConnectX-5 MCX515A- CCAT 1 x 100GbE QSFP PCI NIC) |  4.1(1a) |  4.1(1a) |  4.1(1a) |  - |  4.1(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-P -M5D25GF (Mellanox ConnectX-5 MCX512A- ACAT 2 x 25Gb/10GbE SFP PCI) |  4.1(1a) |  4.1(1a) |  4.1(1a) |  - |  4.1(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-O-  M5S100GF (Mellanox ConnectX-5 MCX545B- ECAN 1 x 100GbE QSFP PCI NIC) |  4.1(1a) |  4.1(1a) |  4.1(1a) |  - |  4.1(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-P  -M4D25GF (Mellanox MCX4121A -ACAT Dual Port 10/25G SFP28 NIC) |  4.0(4o) |  4.0(4o) |  4.0(4o) |  - |  4.0(4o) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE-QS100GF (QLogic QL45611HLCU 100GbE) |  4.0(4o) |  4.0(4o) |  4.0(2a) |  - |  4.0(4o) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE -BD16GF (Emulex LPe31002 Dual-Port 16G FC HBA) |  3.2(3a) |  3.2(3a) |  3.2(3a) |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE -ID40GF (Intel XL710 adapter) |  3.2(3a) |  3.2(3a) |  3.2(3a) |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE -IQ10GF (Intel X710-DA4 adapter) |  3.2(3a) |  3.2(3a) |  3.2(3a) |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE -ID10GF (Intel X710-DA2 adapter) |  3.2(3a) |  3.2(3a) |  3.2(3a) |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE -ID25GF (Intel XXV710-DA2 Dual port 25 Gigabit Ethernet PCIe adapter) |  3.2(3a) |  3.2(3a) |  3.2(3a) |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE -ID10GC (Intel X550-T2 adapter) |  3.2(3a) |  3.2(3a) |  3.2(3a) |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
N2XX-AIPCI01 (Intel X520 dual port adapter) |  3.2(3a) |  3.2(3a) |  3.2(3a) |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE -ID25GF (Intel X710 25Gb Dual-port BaseT) |  3.2(3a) |  3.2(3a) |  3.2(3a) |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE -QD40GF (QLogic QL45412H 40GbE) |  3.2(2b) |  3.2(2b) |  3.2(2b) |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE -IQ10GC (Intel X710-T4) |  3.2(2b) |  3.2(2b) |  3.2(2b) |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE -QD16GF (QLogic QLE2692-CSC) |  3.2(1d) |  3.2(1d) |  3.2(1d) |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCS-VIC -M82-8P (UCS VIC 1280) UCSB-MLOM -40G-01 (UCS VIC 1240) UCSB-MLOM-PT-01  (Cisco Port Expander Card) |  2.2(8a) |  3.1(3a)  |  3.1(3a)  |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-F-FIO -1000MP (Cisco UCS Fusion ioMemory – PX600, 1.0TB) UCSC-F-FIO -1300MP (Cisco UCS Fusion ioMemory – PX600, 1.3TB) UCSC-F-FIO -2600MP (Cisco UCS Fusion ioMemory – PX600, 2.6TB) UCSC-F-FIO -5200MP (Cisco UCS Fusion ioMemory – PX600, 5.2TB) |  2.2(8a) |  3.1(3a)  |  3.1(3a)  |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSB-FIO -1600MS (Cisco UCS Fusion ioMemory Mezzanine SX300, 1.6TB) UCSB-FIO -1300MS (Cisco UCS Fusion ioMemory Mezzanine PX600, 1.3TB) |  2.2(8a) |  3.1(3a)  |  3.1(3a)  |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-INVADER -3108  UCSC-NYTRO -200GB (Cisco Nytro MegaRAID 200GB Controller) |  2.2(8a) |  3.1(3a)  |  3.1(3a)  |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-MLOM -C10T-02 (UCS VIC 1227T) UCSC-PCIE -C10T-02 (UCS VIC 1225T) UCSC-F-FIO -785M (Cisco UCS 785GB MLC Fusion ioDrive2 for C-Series Servers) UCSC-F-FIO -365M (Cisco UCS 365GB MLC Fusion ioDrive2 for C-Series Servers) UCSC-F-FIO -1205M (Cisco UCS 1205GB MLC Fusion ioDrive2 for C-Series Servers) UCSC-F-FIO -3000M (Cisco UCS 3.0TB MLC Fusion ioDrive2 for C-Series Servers) UCSC-F-FIO -1000PS (UCS 1000GB Fusion ioMemory3 PX Performance line for Rack M4) UCSC-F-FIO -1300PS (UCSC-F-FIO-1300PS) UCSC-F-FIO -2600PS (UCS 2600GB Fusion ioMemory3 PX Performance line for Rack M4) UCSC-F-FIO -5200PS (UCS 5200GB Fusion ioMemory3 PX Performance line for Rack M4) UCSC-F-FIO -6400SS (UCS 6400GB Fusion ioMemory3 SX Scale line for C-Series) UCSC-F-FIO -3200SS (UCS 3200GB Fusion ioMemory3SX Scale line for C-Series) |  2.2(8a) |  3.1(3a)  |  3.1(3a)  |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE -E14102B (Emulex OCe14102B-F) |  2.2(8a) |  3.1(3a)  |  3.1(3a)  |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE -IQ10GF (Intel X710-DA4 adapter) UCSC-PCIE -ID10GF (Intel X710-DA2 adapter) UCSC-PCIE -ID40GF (Intel XL710 adapter) |  —  |  —  |  3.1(3a)  |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-F-I80010  (Intel P3700 HHHL 800GB NVMe PCIe SSD) UCSC-F-I12003  (Intel P3600 HHHL 1200GB NVMe PCIe SSD) UCSC-F-I160010  (Intel P3700 HHHL 1600GB NVMe PCIe SSD) UCSC-F-I20003  (Intel P3600 HHHL 2000GB NVMe PCIe SSD ) UCS-PCI25 -40010 (Intel P3700 400GB NVMe PCIe SSD) UCS-PCI25 -8003 (Intel P3600 800GB NVMe PCIe SSD) UCS-PCI25 -80010 (Intel P3700 800GB NVMe PCIe SSD) UCS-PCI25 -16003 (Intel P3600 1600GB NVMe PCIe SSD) UCSC-F-H19001  (UCS Rack PCIe/NVMe Storage 1900GB HGST SN150) UCSC-F-H38001  (UCS Rack PCIe/NVMe Storage 3800GB HGST SN150) UCS-PCI25 -38001 (UCS PCIe/NVMe2.5"SFF Storage 3800GB HGST SN100) |  —  |  3.1(3a)  |  3.1(3a)  |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE -QD32GF (Qlogic QLE2742) N2XX-AQPCI05 (Qlogic QLE2562)  UCSC-PCIE -Q2672 (Qlogic QLE2672-CSC) UCSC-PCIE -BD32GF (Emulex LPe32002) UCSC-PCIE -BS32GF (Emulex LPe32000) N2XX-AEPCI05 (Emulex LPe12002)  |  3.1(3a) |  3.1(3a) |  3.1(3a) |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE -E16002 (Emulex LPe16002-M6 16G FC rack HBA) |  3.1(3a) |  3.2(1d) |  3.2(1d) |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE -ID10GC (Intel X550 Dual-port 10GBase-T NIC) |  3.1(2b) |  3.1(3a) |  3.1(3a) |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-O -ID25GF (Intel XXV710 - DA2 - OCP1 2x25/10GbE OCP 2.0 adapter) |  3.1(3a) |  4.1(1a) |  4.1(1a) |  - |  4.1(1a) |  - |  4.1(1a) |  - |  - |  4.2(3s)  
UCSC-OCP -QD10GC (QLogic FastLinQ QL41132H Dual Port 10GbE Adapter)  | 4.0(1a) | 4.0(1a) | 4.0(1a) |  - | 4.0(1a) |  - | 4.0(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE -QD25GF (QLogic FastLinQ QL41212H 25GbE adapter ) |  3.1(3a) |  3.1(3a) |  3.1(3a) |  - |  4.0(1a) |  - |  4.0(1a) |  - |  - |  4.2(3s)  
UCSC-OCP -QD25GF (QLogic FastLinQ QL41232H Dual Port 25GbE Adapter)  | 4.0(1a) | 4.0(1a) | 4.0(1a) |  - | 4.0(1a) |  - | 4.0(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE -QD40GF (à QLogic FastLinQ QL45412H 40GbE adapter) |  3.1(3a) |  3.1(3a) |  3.1(3a) |  - |  4.0(1a) |  - |  4.0(1a) |  - |  - |  4.2(3s)  
UCSC-PCIE -QD10GC (Qlogic QL41162HLRJ-11-SP dual-port 10GBase-T CAN)  |  4.0(2a) |  4.0(2a) |  4.0(2a) |  - |  4.0(2a) |  - |  4.0(2a) |  - |  - |  4.2(3s)  
UCSC-P -Q6D32GF (Cisco-QLogic QLE2772 2x32GFC Gen 6 Enhanced PCIe HBA) |  4.2(1l) |  4.2(1l) |  4.2(1l) |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  4.2(3s)  
UCSC-P -M6CD100GF (Mellanox MCX623106AC-CDAT 2x100GbE QSFP56 PCIe NIC) |  4.2(1l) |  4.2(1l) |  4.2(1l) |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  4.2(3s)  
UCSC-P -M6DD100GF (Mellanox MCX623106AS-CDAT 2x100GbE QSFP56 PCIe NIC) |  4.2(1l) |  4.2(1l) |  4.2(1l) |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  4.2(3s)  
UCSC-P -B7D32GF (Cisco-Emulex LPe35002-M2-2x32GFC Gen 7 PCIe HBA) |  4.2(1l) |  4.2(1l) |  4.2(1l) |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  4.2(3s)  
UCSC-P -I8D100GF(Cisco - Intel E810CQDA2 2x100 GbE QSFP28 PCIe NIC) |  4.2(1l) |  4.2(1l) |  4.2(1l) |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  4.2(3s)  
UCSC-P -I8Q25GF (Cisco - Intel E810XXVDA4 4x25/10 GbE SFP28 PCIe NIC) |  4.2(1l) |  4.2(1l) |  4.2(1l) |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  4.2(3s)  
UCSC-P -I8D25GF (Cisco - Intel E810XXVDA2 2x25/10 GbE SFP PCIe NIC) |  4.2(1l) |  4.2(1l) |  4.2(1l) |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  4.2(3s)  
UCSC-P -ID10GC (Cisco - Intel X710T2LG 2x10 GbE RJ45 PCIe NIC) |  4.2(1l) |  4.2(1l) |  4.2(1l) |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  4.2(3s)  
UCSC-O-N6CD100GF (Cisco-NVDA MCX623436AC-CDAB CX6Dx 2x100G QSFP56 x16 OCP NIC) |  4.2(3e) |  4.2(3e) |  4.2(3e) |  - |  4.2(3e) |  - |  4.2(3e) |  - |  - |  4.2(3s)  
UCSC-O-N6CD25GF (Cisco-NVDA MCX631432AC-ADAB CX6 Lx 2x25G SFP28 x8 OCP NIC) |  4.2(3e) |  4.2(3e) |  4.2(3e) |  - |  4.2(3e) |  - |  4.2(3e) |  - |  - |  4.2(3s)  
...
---|---|---  
UCSB-5108-AC2  |  3.0(1e)  |  4.2(3s)  
UCSB-5108-DC2  |  3.0(2c)  |  4.2(3s)  
...
---|---|---  
B200 M6 |  4.2(1d) |  4.2(3s)  
B200 M5 |  4.0(1a) |  4.2(3s)  
B200 M4  |  4.0(1a) |  4.2(3s)  
B260 M4  |  4.0(1a) |  4.2(3s)  
B420 M4  |  4.0(1a) |  4.2(3s)  
B460 M4  |  4.0(1a) |  4.2(3s)  
B480 M5 |  4.0(1a) |  4.2(3s)  
C220 M4  |  4.0(1a) |  4.2(3s)  
C240 M4  |  4.0(1a) |  4.2(3s)  
C460 M4 |  4.0(1a) |  4.2(3s)  
C220 M5 |  4.0(1a) |  4.2(3s)  
C240 M5 |  4.0(1a) |  4.2(3s)  
C480 M5 |  4.0(1a) |  4.2(3s)  
...
UCSC-PCIE-C40Q-03 (UCS VIC 1385)  UCSC-MLOM-C40Q-03 (UCS VIC 1387)  |  3.1(3a)  |  4.2(3s)  
UCS-VIC-M82-8P (UCS VIC 1280) UCSB-MLOM-40G-01 (UCS VIC 1240) UCSB-MLOM-PT-01 (Cisco Port Expander Card) |  3.1(3a)  |  4.2(2d)  
UCSB-MLOM-40G-03 (UCS VIC 1340) UCSB-VIC-M83-8P (UCS VIC 1380) UCSC-MLOM-CSC-02 (UCS VIC 1227) |  3.1(3a)  |  4.2(3s)  
...
UCSC-PCIE-C25Q-04 (UCS VIC 1455) |  4.2(2a) |  4.2(3s)  
UCSC-MLOM-C25Q-04 (UCS VIC 1457) |  4.2(2a) |  4.2(3s)  
  
#### UCS Mini Supported Fabric Interconnects

Fabric Interconnects  |  Minimum Software Version  |  Suggested Software Version   
---|---|---  
Cisco UCS 6324  |  3.1(3a)  |  4.2(3s)  
...
---|---|---  
UCS 2204 XP  | 3.1(3a) |  4.2(3s)  
UCS 2208 XP  | 3.1(3a) |  4.2(3s)  
  
#### UCS Mini Supported Power Supplies

Power Supplies  |  Minimum Software Version  |  Suggested Software Version   
---|---|---  
UCSB-PSU-2500ACDV  UCSB-PSU-2500DC48  UCSC-PSU-930WDC  UCSC-PSU2V2-930WDC  UCSC-PSUV2-1050DC  UCSC-PSU1-770W  UCSC-PSU2-1400  UCSC-PSU2V2-1400W  UCSC-PSU2V2-650W  UCSC-PSU2V2-1200W  |  3.1(3a)  |  4.2(3s)  
...
---|---|---  
4.2(3s) |  ucs-catalog.4.2.3n.T.bin |  —  
4.2(3r) |  ucs-catalog.4.2.3n.T.bin |  —  
...
There are no security fixes in release 4.2(3s). 
...
For more detailed information, see [Cisco FXOS and UCS Manager Software Command Injection Vulnerability](https://sec.cloudapps.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-ucsciv-wGYtC78q). 

### CSCwm68935

A vulnerability in the logging subsystem of the Cisco product could allow an authenticated, local attacker to view sensitive information in a system log file which should be restricted. 

The vulnerability is due to a lack of proper masking of sensitive information before being written to system log files. An attacker could exploit this vulnerability by authenticating to the targeted device and inspecting a specific system log file. A successful exploit could allow the attacker to view sensitive data that was not properly masked. 

Cisco has released software updates that address this vulnerability. Future versions of the product(s) will include the necessary fixes to ensure sensitive information is correctly masked. 

### CSCwn23026

A vulnerability in the CLI and web-based management interface of the Cisco UCS Manager Software could allow an authenticated, remote attacker with valid administrative privileges to execute arbitrary commands on the underlying operating system of an affected device. 

This vulnerability is due to insufficient input validation of command arguments supplied by the user. An attacker could exploit this vulnerability by authenticating to a device and submitting crafted input to the affected command. A successful exploit could allow the attacker to execute arbitrary commands on the underlying operating system of an affected device with root-level privileges. 

Cisco has released software updates that address this vulnerability. Future versions of the product(s) will not be affected by this vulnerability. 

### CSCws66235

A vulnerability in the logging subsystem of the Cisco product could allow an authenticated, local attacker to view sensitive information in a system log file which should be restricted. 

The vulnerability is due to a lack of proper masking of sensitive information before being written to system log files. An attacker could exploit this vulnerability by authenticating to the targeted device and inspecting a specific system log file. The attacker would need valid user credentials to successfully exploit this issue. 
...
The following caveats are resolved in Release 4.2(3s): 

Defect ID |  Symptom |  First Bundle Affected |  Resolved in Release  
---|---|---|---  
CSCwn60596 |  After an infrastructure firmware upgrade, KVM consoles can become inoperable even though the assigned KVM IP address remains reachable. This issue has been observed in domains with multiple chassis and out-of-band management after firmware upgrades or PMON restarts.  This issue is resolved. |  4.3(4a) |  4.2(3s)  
  
### Resolved Caveats in Release 4.2(3r)

The following caveats are resolved in Release 4.2(3r): 

Defect ID |  Symptom |  First Bundle Affected |  Resolved in Release  
---|---|---|---  
CSCwt18924 |  Cisco UCS C220 M6 servers with Cisco UCS VIC 1467 adapters experience an adapter crash caused by a memory leak in the MCP process during an upgrade of the ACI fabric. After the adapter reset, physical ports come back online, but the vNICs remain stuck in initializing and do not recover without a server reboot. This issue occurs when upstream ACI switches are upgraded and rebooted, causing link flaps and requiring manual server reboot for vNICs recovery. The adapter logs indicate fatal errors related to out-of-memory conditions leading to the MCP process termination and adapter reset.  This issue is resolved. |  4.2(3m) |  4.2(3r)  
CSCwo84672 |  The UCS-S3260-NVMW64T drive may report a Drive Failed. Needs reseat or replacement: Fault State 1 error. The failure is also logged in OBFL logs and the drive status shows as failed with a corresponding LED fault indication.  This issue is resolved. |  4.3(6c) |  4.2(3r)  
...
There are no open caveats in release 4.2(3s). 

### Open Caveats for Release 4.2(3r)

There are no open caveats in release 4.2(3r). 
...
There are no known limitations in release 4.2(3s). 

### Release 4.2(3r)

There are no known limitations in release 4.2(3r). 
...
## Contents
  ...
  * Adapters
  * Cisco UCS Fabric Interconnect Server Compatibility Matrix - Release 6.0(2d)
...
UCS X410c M8 |  6.0(2b) |  6.0(2b) |  6.0(2b) |  6.0(2b) |  6.0(2b) |  6.0(2b) |  6.0(2d)  
UCS X210c M8 |  6.0(2b) |  6.0(1b) |  4.3(6a) |  4.3(6a) |  4.3(6a) |  4.3(6a) |  6.0(2d)  
UCS X215c M8 |  6.0(2b) |  6.0(1b) |  4.3(5a) |  4.3(5a) |  4.3(5a) |  4.3(5a) |  6.0(2d)  
UCS X410c M7 |  6.0(2b) |  6.0(1b) |  4.3(2c) |  4.3(2c) |  4.3(2c) |  4.3(4b) |  6.0(2d)  
UCS X210c M7 |  6.0(2b) |  6.0(1b) |  4.3(2b) |  4.3(2b) |  4.3(2b) |  4.3(4b) |  6.0(2d)  
UCS X210c M6 |  6.0(2b) |  6.0(1b) |  4.3(2b) |  4.3(2b) |  4.3(2b) |  4.3(4b) |  6.0(2d)  
UCS B200 M6 |  6.0(2b) |  6.0(2b) |  4.2(3r) |  4.2(1d) |  4.2(1d) |  - |  6.0(2d)  
UCS B200 M5 |  6.0(2b) |  6.0(2b) |  4.2(3r) |  4.0(1a) |  4.1(1a) |  - |  6.0(2d)  
UCS B480 M5 |  - |  - |  4.2(3r) |  4.0(1a) |  4.1(1a) |  - |  6.0(2d)  
![](https://www.cisco.com/content/dam/en/us/td/i/templates/note.gif)  
**Note** | 
...
---|---|---|---|---|---|---  
Cisco UCS C240 M8 |  6.0(2b) |  6.0(1b) |  4.3(6a) |  4.3(6a) |  4.3(6a) |  6.0(2d)  
Cisco UCS C220 M8 |  6.0(2b) |  6.0(1b) |  4.3(6a) |  4.3(6a) |  4.3(6a) |  6.0(2d)  
Cisco UCS C225 M8 |  6.0(2b) |  6.0(1b) |  4.3(5a) |  4.3(5a) |  4.3(5a) |  6.0(2d)  
Cisco UCS C245 M8 |  6.0(2b) |  6.0(1b) |  4.3(4b) |  4.3(4b) |  4.3(4b) |  6.0(2d)  
Cisco UCS C240 M7 |  6.0(2b) |  6.0(1b) |  4.3(2b) |  4.3(2b) |  4.3(2b) |  6.0(2d)  
Cisco UCS C220 M7 |  6.0(2b) |  6.0(1b) |  4.3(2b) |  4.3(2b) |  4.3(2b) |  6.0(2d)  
Cisco UCS C220 M6 |  6.0(2b) |  6.0(1b) |  4.2(3r) |  4.2(1d) |  4.2(1d) |  6.0(2d)  
Cisco UCS C240 M6 |  6.0(2b) |  6.0(1b) |  4.2(3r) |  4.2(1d) |  4.2(1d) |  6.0(2d)  
Cisco UCS C225 M6 |  6.0(2b) |  6.0(1b) |  4.2(3r) |  4.2(1l) |  4.2(1l) |  6.0(2d)  
Cisco UCS C245 M6 |  6.0(2b) |  6.0(1b) |  4.2(3r) |  4.2(1i) |  4.2(1i) |  6.0(2d)  
Cisco UCS C220 M5 |  - |  - |  4.2(3r) | 4.0(1a) |  4.1(1a) |  6.0(2d)  
Cisco UCS C240 M5 |  - |  - |  4.2(3r) | 4.0(1a) |  4.1(1a) |  6.0(2d)  
Cisco UCS C125 M5 |  - |  - |  4.2(3r) | 4.0(1a) |  4.1(1a) |  6.0(2d)  
Cisco UCS S3260 M5 |  - |  - |  4.2(3r) | 4.0(1a) |  4.1(1a) |  6.0(2d)  
Cisco UCS C480 M5 ML |  - |  - |  4.2(3r) |  4.0(2a) |  4.1(1a) |  6.0(2d)  
Cisco UCS C480 M5 |  - |  - |  4.2(3r) | 4.0(1a) |  4.1(1a) |  6.0(2d)  
...
---|---|---  
Cisco UCS X9508 Chassis |  4.3(4b) |  6.0(2d)  
...
---|---|---  
X410c M8 |  6.0(2b) |  6.0(2d)  
X210c M8 |  4.3(6a) |  6.0(2d)  
X215c M8 |  4.3(5a) |  6.0(2d)  
X210c M7 |  4.3(4b) |  6.0(2d)  
X410c M7 |  4.3(4b) |  6.0(2d)  
X210c M6 |  4.3(4b) |  6.0(2d)  
...
---|---|---  
C240 M8 |  6.0(1b) |  6.0(2d)  
C220 M8 |  6.0(1b) |  6.0(2d)  
C245 M8 |  6.0(1b) |  6.0(2d)  
C225 M8 |  6.0(1b) |  6.0(2d)  
C240 M7 |  6.0(1b) |  6.0(2d)  
C220 M7 |  6.0(1b) |  6.0(2d)  
...
UCSC-M-V5Q50GV2 (Cisco UCS VIC 15427 Quad-port 10/25/50-G mLOM)  |  - |  6.0(2b) |  - |  6.0(1b) |  - |  4.3(2c) |  4.3(2c) |  - |  4.3(2c) |  - |  6.0(2d)  
UCSX-ML-V5D200GV2 (Cisco UCS VIC 15230 Dual-port 100-G mLOM)  |  6.0(2b) |  - |  6.0(1b) |  - |  - |  4.3(2c) |  4.3(2c) |  - |  4.3(2c) |  4.3(6h) |  6.0(2d)  
UCSC-M-V5D200GV2 (Cisco UCS VIC 15237 mLOM Dual-port 40/100/200-G mLOM)  |  - |  6.0(2b) |  - |  6.0(1b) |  - |  4.3(2c) |  4.3(2c) |  - |  4.3(2c) |  - |  6.0(2d)  
UCSX-ML-V5D200G (Cisco UCS VIC 15231 Dual-port 100-G mLOM) |  6.0(2b) |  - |  6.0(1b) |  - |  - |  4.3(2b) |  4.3(2b) |  - |  4.3(2b) |  4.3(6h) |  6.0(2d)  
UCSX-ME-V5Q50G (Cisco UCS VIC 15422 Quad-port 25G mezzanine) |  6.0(2b) |  - |  6.0(1b) |  - |  - |  4.3(2b) |  4.3(2b) |  - |  4.3(2b) |  - |  6.0(2d)  
UCSX-ML-V5Q50G (Cisco UCS VIC 15420 Quad-port 25G mLOM) |  6.0(2b) |  - |  6.0(1b) |  - |  - |  4.3(2b) |  4.3(2b) |  - |  4.3(2b) |  4.3(6h) |  6.0(2d)  
UCSX-V4-Q25GML (Cisco UCS VIC 14425 Quad-port 25G mLOM)  |  6.0(2b) |  - |  6.0(1b) |  - |  - |  4.3(2b) |  4.3(2b) |  - |  4.3(2b) |  4.3(6h) |  6.0(2d)  
UCSX-V4-Q25GME (Cisco VIC 14825 Quad-port 25G mezzanine)  |  6.0(2b) |  - |  6.0(1b) |  - |  - |  4.3(2b) |  4.3(2b) |  - |  4.3(2b) |  - |  6.0(2d)  
UCSC-P-V5D200G (Cisco UCS VIC 15235 Dual-port 40/100/200-G PCIe\\) |  - |  6.0(2b) |  - |  6.0(1b) |  - |  - |  - |  - |  - |  - |  6.0(2d)  
UCSC-P-V5Q50G (Cisco UCS VIC 15425 Quad-port 10/25/50-G PCIe |  - |  6.0(2b) |  - |  6.0(1b) |  - |  4.3(2b) |  - |  4.3(2b) |  4.3(2b) |  - |  6.0(2d)  
UCSC-M-V5Q50G (Cisco UCS VIC 15428 MLOM 4-port adapter) |  - |  6.0(2b) |  - |  6.0(1b) |  - |  4.2(1d) |  - |  - |  4.2(3r) |  - |  6.0(2d)  
UCSC-M-V5D200G (Cisco UCS VIC 15238 MLOM adapter) Direct Attached only |  - |  6.0(2b) |  - |  6.0(1b) |  - |  - |  - |  4.2(3r) Direct Attached only (40/100G) |  4.2(3r) Direct Attached only (40/100G) |  - |  6.0(2d)  
UCSBMLV5Q 10G  (Cisco VIC 15411) |  - |  - |  - |  - |  4.2(1d) |  - |  4.2(1d) |  4.2(3r) |  - |  - |  6.0(2d)  
UCSC-PCIE-C100 -04  (Cisco UCS VIC 1495) |  - |  6.0(2b) |  - |  6.0(1b) |  4.0(2a) * |  - |  4.0(2a) * |  4.2(3r) Direct Attach only (40/100G) |  4.2(3r) Direct Attach only (40/100G) |  - |  6.0(2d)  
UCSC-MLOM-C100 -04  (Cisco UCS VIC 1497) |  - |  - |  - |  - |  4.0(2a) * |  - |  4.0(2a) * |  4.2(3r) Direct Attach only (40/100G) |  4.2(3r) Direct Attach only (40/100G) |  - |  6.0(2d)  
UCSB-MLOM- 40G-04  (UCS VIC 1440) |  - |  - |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  4.2(3r) |  - |  - |  6.0(2d)  
UCSCM- V25-04 (UCS VIC 1467) |  - |  6.0(2b) |  - |  6.0(1b) |  - |  4.2(1l) |  - |  - |  4.2(3r) |  - |  6.0(2d)  
UCSC-M-V100-04 (UCS VIC 1477) |  - |  6.0(2b) |  - |  6.0(1b) |  - |  - |  - |  4.2(3r) Direct Attached only |  - |  6.0(2d)  
UCSB-VIC- M84-4P  (UCS VIC 1480) |  - |  - |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  4.2(3r) |  - |  - |  6.0(2d)  
UCSC-PCIE- C25Q-04  (UCS VIC 1455) |  - |  6.0(2b) |  - |  6.0(1b) |  4.0(1a) * |  4.2(3r) |  4.1(1a) * |  - |  4.2(3r) |  - |  6.0(2d)  
UCSC-MLOM- C25Q-04  (UCS VIC 1457) |  - |  - |  - |  - |  4.0(1a) * |  4.2(3r) |  4.1(1a) * |  - |  4.2(3r) |  - |  6.0(2d)  
UCSC-PCIE-C40Q -03 (UCS VIC 1385) UCSC-MLOM-C40Q -03 (UCS VIC 1387) |  - |  - |  - |  - |  4.0(1a) * |  4.2(3r) |  4.1(1a) * |  - |  4.2(3r) |  - |  6.0(2d)  
UCSB-MLOM- 40G-03 (UCS VIC 1340) UCSB-VIC- M83-8P (UCS VIC 1380) |  - |  - |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  4.2(3r) |  - |  - |  6.0(2d)  
UCSC-PCIE -BD16GF (Emulex LPe31002 Dual-Port 16G FC HBA) |  - |  - |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(2d)  
UCSC-PCIE -ID40GF (Intel XL710 adapter) |  - |  - |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(2d)  
UCSC-PCIE -IQ10GF (Intel X710-DA4 Quad Port 10G Ethernet PCIe adapter) |  - |  - |  - |  - |  4.0(1a)* |  - |  4.1(1a)* |  - |  - |  - |  6.0(2d)  
UCSC-PCIE -ID10GF (Intel X710-DA2 Dual Port 10G Ethernet PCIe adapter) |  - |  - |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(2d)  
UCSC-PCIE -ID40GF: Intel XL710-QDA2 Dual port 40 Gigabit  Ethernet PCIe adapter  |  - |  - |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(2d)  
UCSC-PCIE -ID25GF (Intel XXV710-DA2 Dual port 25 Gigabit Ethernet PCIe adapter) |  - |  - |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(2d)  
UCSC-PCIE -ID10GC (Intel X550-T2 adapter) |  - |  - |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(2d)  
N2XX-AIPCI01 (Intel X520 dual port adapter) |  - |  - |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(2d)  
UCSC-PCIE-IRJ45:  Intel Ethernet Server Adapter I350-T4 |  - |  - |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(2d)  
UCSC-MLOM-IRJ45:  Intel Ethernet I350-mLOM 1 Gbps Network Controller |  - |  - |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(2d)  
UCSC-PCIE -ID25GF (Intel X710 25Gb Dual-port BaseT) |  - |  - |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(2d)  
UCSC-PCIE -IQ10GC (Intel X710-T4) |  - |  - |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(2d)  
UCSC-PCIE -IQ10GF (Intel X710-DA4 adapter) UCSC-PCIE -ID40GF (Intel XL710 adapter) |  - |  - |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(2d)  
UCSC-PCIE -BD32GF (Emulex LPe32002) UCSC-PCIE -BS32GF (Emulex LPe32000 Single-Port 32G FC HBA) |  - |  - |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(2d)  
UCSC-PCIE -E16002 (Emulex LPe16002-M6 16G FC rack HBA) |  - |  - |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(2d)  
UCSC-PCIE -ID10GC (Intel X550 Dual-port 10GBase-T NIC) |  - |  - |  - |  - |  4.0(1a) * |  - |  4.1(1a) * |  - |  - |  - |  6.0(2d)  
UCSC-O -ID25GF (Intel XXV710 - DA2 - OCP1 2x25/10GbE OCP 2.0 adapter) |  - |  - |  - |  - |  4.0(1a) * |  - |  4.0(1a) * |  - |  - |  - |  6.0(2d)  
UCSC-P -Q6D32GF (Cisco-QLogic QLE2772 2x32GFC Gen 6 Enhanced PCIe HBA) |  - |  - |  - |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  - |  6.0(2d)  
UCSC-P -B7D32GF (Cisco-Emulex LPe35002-M2-2x32GFC Gen 7 PCIe HBA) |  - |  - |  - |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  - |  6.0(2d)  
UCSC-P -I8D100GF(Cisco - Intel E810CQDA2 2x100 GbE QSFP28 PCIe NIC) |  - |  - |  - |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  - |  6.0(2d)  
UCSC-P -I8Q25GF (Cisco - Intel E810XXVDA4 4x25/10 GbE SFP28 PCIe NIC) |  - |  - |  - |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  - |  6.0(2d)  
UCSC-P -I8D25GF (Cisco - Intel E810XXVDA2 2x25/10 GbE SFP PCIe NIC) |  - |  - |  - |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  - |  6.0(2d)  
UCSC-P -ID10GC (Cisco - Intel X710T2LG 2x10 GbE RJ45 PCIe NIC) |  - |  - |  - |  - |  4.2(1l) |  - |  4.2(1l) |  - |  - |  - |  6.0(2d)  
UCSC-O -ID10GC: Cisco(R) X710T2LG 2x10 GbE  RJ45 OCP 3.0 NIC |  - |  - |  - |  - |  4.2(1d) |  4.2(1d) |  4.2(1d) |  4.2(1d) |  4.2(1d) |  - |  6.0(2d)  
...
UCSB-RAID12G-M6:  Cisco FlexStorage 12G SAS  RAID Controller |  - |  - |  - |  - |  4.2(1d) |  4.2(1d) |  4.2(1d) |  4.2(1d) |  4.2(1d) |  - |  6.0(2d)  
UCSC-SAS-M6T:  Cisco M6 12G SAS HBA for (16 Drives)  |  - |  - |  - |  - |  4.2(1d) |  4.2(1d) |  4.2(1d) |  4.2(1d) |  4.2(1d) |  - |  6.0(2d)  
UCSX-X10C-RAIDF:  UCS X10c Compute RAID Controller |  - |  - |  - |  - |  - |  - |  - |  - |  - |  - |  6.0(2d)  
Cisco Mini Storage Carrier for M.2 SATA-SWRAID Mode |  - |  - |  - |  - |  4.2(1d) |  4.2(1d) |  4.2(1d) |  4.2(1d) |  4.2(1d) |  - |  6.0(2d)  
Cisco UCSC-P-M5S100GF (Mellanox ConnectX-5 MCX515A-CCAT 1 x 100GbE QSFP PCI NIC) |  - |  - |  - |  - |  4.1(1a) |  - |  4.1(1a) |  - |  - |  - |  6.0(2d)  
Cisco UCSC-P-M5D25GF (Mellanox ConnectX-5 MCX512A-ACAT 2 x 25Gb/10GbE SFP PCI) |  - |  - |  - |  - |  4.1(1a) |  - |  4.1(1a) |  - |  - |  - |  6.0(2d)  
Cisco UCSC-O-M5S100GF (Mellanox ConnectX-5 MCX545B-ECAN 1 x 100GbE QSFP PCI NIC) |  - |  - |  - |  - |  4.1(1a) |  - |  4.1(1a) |  - |  - |  - |  6.0(2d)  
Cisco UCSC-PCIE-QS100GF (QLogic R FastLinQ QL45611H 100GbE) |  - |  - |  - |  - |  4.0(4o) |  - |  4.1(1a) |  - |  - |  - |  6.0(2d)  
Cisco UCSC-PCIE-QD40GF (QLogic QL45412H 40GbE) |  - |  - |  - |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  - |  6.0(2d)  
Cisco UCSC-PCIE-QD16GF (QLogic QLE2692 16GB dual Port FC HBA) |  - |  - |  - |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  - |  6.0(2d)  
Cisco UCSC-PCIE-QD25GF (QLogic FastLinQ QL41212H 25GbE adapter) |  - |  - |  - |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  - |  6.0(2d)  
Cisco UCSC-OCP-QD25GF (QLogic FastLinQ QL41232H Dual Port 25GbE Adapter) |  - |  - |  - |  - |  4.0(1a) |  - |  4.0(1a) |  - |  - |  - |  6.0(2d)  
Cisco UCSC-OCP-QD10GC (QLogic FastLinQ QL41132H Dual Port 10GbE Adapter) |  - |  - |  - |  - |  4.0(1a) |  - |  4.0(1a) |  - |  - |  - |  6.0(2d)  
Cisco UCSC-PCIE-QD10GC (Qlogic QL41162HLRJ-11-SP dual-port 10GBase-T CNA) |  - |  - |  - |  - |  4.0(2a) |  - |  4.0(2a) |  - |  - |  - |  6.0(2d)  
Cisco UCSB-MLOM-PT-01 (Cisco Port Expander Card) |  - |  - |  - |  - |  4.0(1a) |  - |  4.0(1a) |  - |  - |  - |  6.0(2d)  
Cisco UCSC-PCIE-QD32GF (Qlogic QLE2742 Dual Port 32Gb FC HBA) |  - |  - |  - |  - |  4.0(1a) |  - |  4.1(1a) |  - |  - |  - |  6.0(2d)  
![](https://www.cisco.com/content/dam/en/us/td/i/templates/note.gif)  
**Note** | 
...
## Contents
  ...
  * Behavior Changes in Release 2.1(2b)
  ...
  * Upgrade Paths
  * Known Behavior and Limitations in Release 2.1
  * Security Fixes
  * Resolved Caveats in Release 2.1
  * Resolved Caveats in Release 2.1(2b)
  * Resolved Caveats in Release 2.1(2a)
  * Resolved Caveats in Release 2.1(1c)
  * Resolved Caveats in Release 2.1(1a)
  * Open Caveats in Release 2.1
  * Open Caveats in Release 2.1(2b)
...
---|---|---  
2.1(2b) |  May 21, 2026 |  Created release notes for Cisco UCS Central Release 2.1(2b).  Updated the following sections: 
...
2.1(1c) |  September 4, 2025 |  Updated the following sections: 
...
August 13, 2025 |  Updated the following sections: 

  * Feature Support Matrix
  * Resolved Caveats in Release 2.1(1c)

  
2.1(1b) |  August 12, 2025 |  Updated the following section: Open Caveats in Release 2.1(1b)  
July 28, 2025 |  Updated the following sections: 
...
### New Hardware in Release 2.1(2b)

### Peripherals

Following peripherals are supported from release 2.1(2b) onwards:
...
---|---  
2.1(2b) |  4.1(3), 4.2 up to 4.2(3), 4.3(2), 4.3(3), 4.3(4), 4.3(5), 4.3(6), 6.0(1), 6.0(2)  
...
2.1(2a) |  2.1(2b) and later |  CLI  
2.1(2b) |  — |  CLI  
  
### For 2.1(2b)

  * You can directly upgrade from Cisco UCS Central release 2.1(1a), 2.1(1b), 2.1(1c) and 2.1(2a) to Cisco UCS Central release 2.1(2b). 

  * Backup restoration to Cisco UCS Central Release 2.1(2b) is supported from Cisco UCS Central release version 2.0(1s) and later.


For information on the behavior changes introduced in Release 2.1(2b), refer to the Behavior Changes in Release 2.1(2b) section. 
...
For information on the behavior changes introduced in Release 2.1(2b), refer to the Behavior Changes in Release 2.1(2a) section. 
...
### Known Behavior and Limitations in Release 2.1(2b)

Defect ID  |  Symptom  |  Workaround   
---|---|---  
CSCwt96689 |  In Cisco UCS Central, the Major Fault messages related to Maximum Session Per User provide inaccurate limit values and ranges for specific Fabric Interconnect (FI) types.  Additionally, typographical errors ("maximun") have been identified within these fault messages. This update corrects the error descriptions and ensures that fault clearing logic triggers correctly based on the accurate hardware limits.  **Affected Components:**

  * **X-Direct Domains:** Incorrectly reports a maximum limit of 16 (actual limit is 12). 
  * **4G/5G/6G Domains:** Incorrectly reports the allowed range as "124" (actual range is 1-24). 

When configuring "Maximum Session Per User" policies, the system displays incorrect fault messages:

  * **X-Direct:** Displays "Session value 32 exceeds the maximun limit of 16. Allowed range: 1-16." 
  * **4G/5G/6G:** Displays "SessionsPerUser value 32 exceeds the maximum limit of 24. Allowed range: 124." 

|  There is no workaround.  
  
### Known Behavior and Limitations in Release 2.1(1c)

The Cisco UCS 6664 Fabric Interconnect infrastructure firmware cannot be added through the Cisco UCS Central GUI or CLI.

### Known Behavior and Limitations in Release 2.1(1b)

There are no known behavior and limitations in Release 2.1(1b). 

### Known Behavior and Limitations in Release 2.1(1a)
...
The following caveats have been resolved in Cisco UCS Central release 2.1(2b): 

Defect ID |  Description  
---|---  
CSCwr45561 |  The Automated Software Distribution feature in Cisco UCS Central fails to download Cisco UCS Manager software bundles due to an error while obtaining the OauthToken. The device activation prompt fails to appear in the Cisco UCS Central GUI during the firmware bundle download process.  This issue is environment-specific. If you encounter the following error message: ObtainAuthToken failed: HTTP response not received/JSON response not received Verify the network connectivity between the UCS Central instance and `id.cisco.com`.   
CSCwt80640 |  In Cisco UCS Central release 2.1(2a), scheduled backup and export tasks fail to execute or produce output.  This issue is specific to automated schedules; manual on-demand backups remain functional.  
CSCvu69083 |  In Cisco UCS Central 2.0(1f) release, the `resource-mgr` process crashes consistently. This issue occurs when restoring the environment using previously exported configurations or system snapshots.   
...
The following caveat is open in the Cisco UCS Central release 2.1(2b): 

Defect ID  |  Symptom  |  Workaround   
---|---|---  
CSCwt91187  |  A synchronization issue has been identified where Equipment Global Policies (within the System Policies Domain Group) are not successfully pushed to 6.0(2) domains after a domain is suspended and subsequently reactivated.  This behavior is specific to 6.0(2) domains and does not occur with 6.0(1) domains. Additionally, the issue persists even when the `callhome short_txt` profile `maxSize` is configured to 100K.  |  Before pushing any equipment global policy, you must configure the "Max SSH Shell session per user" limit in Central based on the specific Fabric Interconnect (FI) type: 

  * For 4GFI, 5GFI, or 6GFI: Set the session limit to 24 or fewer.
  * For Cisco UCS X-Direct: Set the session limit to 12 or fewer.

Configuration Path: Navigate to: Domain Group > System Profile > Remote Access > Shell Session > Override In the Override menu, set the value of Session per User field according to the specific FI requirements listed above.   
