# Intersight SaaS Supported Systems
...
UCSX-FS-9516| 6.0(1.250229)  
Intelligent Fabric Module (IFM)| UCSX-I-9108-25G| 4.2(1e)  
UCSX-I-9108-100G| 4.2(2a)  
Unified Edge| UCS XE9305| Edge Chassis Management Controller (eCMC)| UCSXE-ECMC-G1| 6.0(1.251005)  
Fabric Extender (FEX)| Cisco Nexus 2232PP|  |  | 4.1(3b)  
N9K-C93180YC-FX3|  |  | 4.2(2a)  
Peripheral Component Interconnect Express (PCIe) node| UCSX-580P-U|  |  | 6.0(1.250229)  
UCSX-440P-U|  |  | 4.2(2b)  
...
B-Series M5 Server| Cisco UCS B200 M5 ServerCisco UCS B480 M5 Server| See [Cisco UCS B200 M5 Server Sec Sheet](https://www.cisco.com/c/en/us/products/servers-unified-computing/ucs-b-series-blade-servers/datasheet-listing.html#anchor443).See [Cisco UCS B480 M5 Server Spec Sheet](https://www.cisco.com/c/en/us/products/servers-unified-computing/ucs-b-series-blade-servers/datasheet-listing.html#anchor441).| 6400 Series and 6536 FI: 4.1(3b)| 4.1(3b)  
...
Graphics processing unit (GPU)| UCSC-GPU-A16UCSC-GPU-A100-80| Not Applicable| 4.2(3b)  
Storage Controller| UCS-M2-HWRAIDUCSC-RAID-M6TUCSC-RAID-M6SDUCSC-RAID-M6HDUCSC-SAS-M6HDUCSC-SAS-M6T| Not Applicable| 4.2(1e)  
C-Series M5 Server| Cisco UCS C220 M5 ServerCisco UCS C240 M5 ServerCisco UCS C480 M5 Server| See [Cisco UCS C220 M5 Server Spec Sheet](https://www.cisco.com/c/en/us/products/servers-unified-computing/ucs-c-series-rack-servers/datasheet-listing.html#anchor744).See [Cisco UCS C240 M5 Server Spec Sheet](https://www.cisco.com/c/en/us/products/servers-unified-computing/ucs-c-series-rack-servers/datasheet-listing.html#anchor744).See [Cisco UCS C480 M5 Server Spec Sheet](https://www.cisco.com/c/en/us/products/servers-unified-computing/ucs-c-series-rack-servers/datasheet-listing.html#anchor744).| 6400 Series and 6536 FI: 4.1(3b)| 4.1(3b)  
...
Cisco UCS Director| Cisco UCS Director 6.6.0.0 and later version  
...
Hitachi Virtual Storage Platform| For VSP One Block High End: A0-05-21-00/00 and laterFor VSP One Block (B20) : A3-02-21-x0/01 and laterFor VSP 5000 Series: 90-03-01-00/00 and laterFor VSP G1000, G1500 and F1500: 80-06-75-00/00 and laterFor VSP G/F 350,370,700,900: 88-05-01-x0/00 and laterFor VSP E-Series: 93-02-02-60/00 and later  
...
*3 Launch HyperFlex Connect supports all browsers except Firefox.
...
Maximum number of concurrent workflow executions| 250Note: The actual number of concurrent workflow executions may vary based on ongoing system activities. For example, system activities such as configuration drift detection or pending changes calculation in profiles can reduce the number of user-initiated workflows that can run concurrently.  
...
For more information, see [Firmware Requirements for VIC Metrics Collection](/help/monitoring/supported_devices_monitoring#firmware_requirements_for_vic_metrics_collection).

## Hardware Requirements for Chassis Metrics Collection

For more information, see [Hardware Requirements for Chassis Metrics Collection](/help/monitoring/supported_devices_monitoring#hardware_Requirements_for_chassis_metrics_collection).

## Firmware Requirements for Chassis and Server–Limit and Utilization Metrics Collection

For more information, see [Firmware Requirements for Chassis and Server–Limit and Utilization Metrics Collection](/help/monitoring/supported_devices_monitoring#firmware_requirements_for_vic_metrics_collection).
...
Cisco Intersight supports Internet Protocol Version 4 (IPv4) and Internet Protocol Version 6 (IPv6).
