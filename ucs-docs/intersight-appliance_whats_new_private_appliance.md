...
| **Long URL** | https://cdn.intersight.com/components/an-hulk/1.0.11-20260225095216527/docs/onprem/data/articles/private_appliance/new_2026/en/index.html |
...
## February 25, 2025 – Appliance Intelligence Bundle Release
...
This patch release includes bug fixes. For more information, see [Bugs](/help/appliance/bugs).
  ...
  * Added support for the Cisco UCS X580p PCIe Node and Cisco UCS X9516 X-Fabric Module on UCS X-Series Direct (9108-100G) Fabric Interconnects.
