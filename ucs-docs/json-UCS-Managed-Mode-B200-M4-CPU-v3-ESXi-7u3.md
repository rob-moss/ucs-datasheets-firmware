# UCS Managed Mode B200 M4 CPU v3 / ESXi 7u3

| | |
|---|---|
| **URL Title** | UCS Managed Mode B200 M4 CPU v3 / ESXi 7u3 |
| **URL** | https://pwc014-nextgen-prod-rcdn.cisco.com/public/v2/searchBy/server/searchResults?serverType_ID=0&serverModel_ID=51,157&processor_ID=61&osVendor_ID=5&osVersion_ID=936&firmwareVersion_ID=-1&manageType=UCSM&searchBy=servers&loadDataFromJson=undefined |
| **Long URL** |  |
| **HTML Title** |  |
| **Source file** | `ucs-docs-raw/json/searchResults__q_5cdcf89670.json` |
| **File type** | JSON |
<<<<<<< HEAD
| **Fetched on** | 2026-08-24 09:18:25 |
=======
| **Fetched on** | 2026-06-30 16:55:56 |
