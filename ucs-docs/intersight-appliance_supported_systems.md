...
| **Long URL** | https://cdn.intersight.com/components/an-hulk/1.0.11-20260414151805446/docs/onprem/data/articles/supported_systems/en/index.html |
| **HTML Title** | Supported Systems |
| **Source file** | `ucs-docs-raw/html/intersight-appliance_supported_systems.html` |
| **File type** | HTML |
| **Fetched on** | 2026-04-16 10:49:45 |
...
Note:
  ...
  * The Intersight Managed Mode (IMM) supports up to 20 chassis and 160 servers within a single FI domain
...
Fabric Interconnects| 
  ...
  * Cisco UCS 6664 and 6652 FI are supported with the UCSX-9508 chassis using UCSX-I-9108-25G and UCSX-I-9108-100G IFMs.

  
Input/Output Module (IOM)| 

  * UCS-IOM-2408 is supported on Cisco UCS 6652 FI with the Cisco UCS 5108 chassis.
