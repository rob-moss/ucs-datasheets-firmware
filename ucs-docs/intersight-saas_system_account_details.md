# Intersight SaaS System Account Details
...
<<<<<<< HEAD
| **Long URL** | https://cdn.intersight.com/components/an-hulk/1.0.11-20260821153740774/docs/cloud/data/resources/settings/en/account_details.html |
| **HTML Title** | Account Details |
| **Source file** | `ucs-docs-raw/html/intersight-saas_system_account_details.html` |
| **File type** | HTML |
| **Fetched on** | 2026-08-24 09:16:28 |
=======
| **Long URL** | https://cdn.intersight.com/components/an-hulk/1.0.11-20260626102158280/docs/cloud/data/resources/settings/en/account_details.html |
| **HTML Title** | Account Details |
| **Source file** | `ucs-docs-raw/html/intersight-saas_system_account_details.html` |
| **File type** | HTML |
| **Fetched on** | 2026-06-30 16:42:40 |
...
You can view your account details and configure some of the parameters in the Account Details option of the General section of the Settings menu. To view the Account Details click the Settings icon > Settings. The Account Details are displayed. The details displayed are:
...
You can modify the account details by clicking Configure. The Account ID and Creation Date cannot be modified. For more information on Account Settings Configuration, see [Account Settings Configuration](/help/settings#account_settings_configuration).
