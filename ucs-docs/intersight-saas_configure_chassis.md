...
| **Long URL** | https://cdn.intersight.com/components/an-hulk/1.0.11-20260731131550565/docs/cloud/data/articles/features/chassis/Configure/en/index.html |
| **HTML Title** | Document |
| **Source file** | `ucs-docs-raw/html/intersight-saas_configure_chassis.html` |
| **File type** | HTML |
| **Fetched on** | 2026-08-05 10:00:12 |
...
Chassis Policies can also be cloned by using the **Policy Clone** wizard with properties that are similar to the existing policies. The clone policy action is available on both the policies list and detailed views. For more information, see [Cloning a Policy](/help/saas/resources/cloning_a_policy#cloning_a_policy).
