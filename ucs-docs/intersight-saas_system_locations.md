...
| **Long URL** | https://cdn.intersight.com/components/an-hulk/1.0.11-20260225095216527/docs/cloud/data/resources/locations/en/locations.html |
...
This feature is available for **Unified Edge systems managed through Intersight SaaS, IMM Fabric Interconnect, UCSM- Fabric Interconnect** and **Standalone Rack servers** that helps establish clear, location-based boundaries for infrastructure visibility and policy application.
...
* To add multiple locations using a CSV file:
...
Location assignment can occur **during the target claim process**. The Location chosen during claim is automatically applied/propagated to the Unified Edge Chassis discovered in the process. For more information, see the Assigning Location during Target Claim section.

## Assigning a Location

To assign a location to a Unified Edge Chassis, IMM Fabric Interconnect, UCS Fabric Interconnect and standalone rack servers.
