...
| **Long URL** | https://cdn.intersight.com/components/an-hulk/1.0.11-20260225095216527/docs/cloud/data/articles/features/custom_hcl/configure/en/index.html |
...
3. To view more information about a server, click the  icon next to it; the server details will be displayed.
4. Click Select.
5. To change the server selection, click Edit Selection.
6. To remove the selected server, click the  icon.  
