...
def _md_header(url: str, raw_path: Path | None = None) -> str:
    ...
    def fetch_html_guide(self, base_url: str) -> tuple[str, str] | None:
        ...
        while queue and len(visited) < self.max_pages:
            ...
            if url == base_url:
                ...
                md_filename = _md_outname(base_url, page_title)
        ...
        md = _md_header(base_url, first_raw)
